...
export const services: Service[] = [
  ...
  },
  {
    ...
    subheadline: "Purpose-designed private cinemas with Dolby Atmos 9.4.6 audio, 4K laser projection, and studio acoustic engineering across India.",
    description:
      "A VARELLI private cinema is an engineered acoustic environment designed to reference standards. Room modes, RT60 decay, 4K Barco laser projection, and Sonus Faber audio calibrated to Dolby Atmos perfection.",
    metaTitle: "Private Cinema Design & Installation India — Dolby Atmos | VARELLI",
    metaDescription:
      "VARELLI designs and installs bespoke private cinemas for luxury residences across Bangalore, Mumbai, Delhi, and Hyderabad. Dolby Atmos 9.4.6, 4K laser projection, room acoustic engineering, and cinema recliners.",
    keywords: [
      ...
      "private cinema Mumbai",
      "private cinema Delhi NCR",
      "private cinema Hyderabad",
    ],
    capabilities: [
      {
    ...
    faqs: [
      {
        ...
        answer: "A private cinema can be realised in rooms from 180 sq. ft. (5.1.2 Dolby Atmos configuration) upward. The ideal room for a 7.1.4 reference setup is 250–350 sq. ft., with a ceiling height of 9–11 ft for optimal height speaker coverage. VARELLI performs a room mode analysis and RT60 calculation for every cinema project to determine the acoustic specification for the available space.",
      },
      {
        question: "How much does a private cinema cost in India?",
        answer: "A private cinema in India costs from ₹8.5 Lakhs for a Classic 5.1.2 Dolby Atmos configuration (180–220 sq. ft., 4K laser projection, acoustic treatment, 4–6 luxury seats) to ₹65 Lakhs+ for a Grand Estate reference cinema (9.4.6 Dolby Atmos, Barco laser projection, Sonus Faber speakers, star ceiling, 12–16 seats). VARELLI publishes transparent package tiers on this page.",
      },
      {
        question: "What is Dolby Atmos and do I need it for a home cinema?",
        answer: "Dolby Atmos is an immersive 3D audio format that adds height channels to traditional 5.1 or 7.1 surround sound. It uses audio objects (up to 128 per mix) precisely positioned in a 360° sphere including overhead. For a dedicated private cinema, Dolby Atmos is strongly recommended — it is the current reference standard for all major streaming platforms (Netflix, Apple TV+, Disney+) and 4K Blu-ray. VARELLI designs all private cinemas to Dolby Atmos specification.",
      },
      {
