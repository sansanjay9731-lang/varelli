...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "VARELLI designs integrated security ecosystems that protect luxury residences across India. Biometric access, smart door locks, smart perimeter analytics, and DoorBird video door phones.",
    metaTitle: "Luxury Smart Home Security Bangalore & India | VARELLI",
    metaDescription: "VARELLI integrates smart security systems for luxury villas in Bangalore, Mumbai, Delhi, and Hyderabad. DoorBird video intercoms, biometric access, 4K Smart Optical CCTV, and automated gates.",
    keywords: [
    ...
    capabilities: [
      ...
      },
      {
        ...
        description: "High-resolution CCTV with remote viewing and smart motion detection.",
        image: "https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=800&q=80",
        imageAlt: "Smart optical CCTV camera mounted on villa exterior",
      },
      {
    ...
    faqs: [
      {
        ...
        answer: "A comprehensive VARELLI security deployment integrates DoorBird (Germany) IP video intercoms, 4K high-definition optical surveillance with perimeter intrusion detection, German/Italian architectural smart locks, motorized gate actuators, glass-break sensors, and isolated local storage NVRs with secure encrypted mobile streaming.",
      },
      {
