...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema Companies in Bangalore — Dedicated Home Cinema Rooms | VARELLI",
  description: "VARELLI is the leading luxury integrator for Private Cinema Companies in Bangalore — Dedicated Home Cinema Rooms. Discover premium smart home and private cinema solutions.",
  path: "/private-cinema-companies-bangalore",
  keywords: ["private-cinema-companies-bangalore", "bangalore"],
})
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "VARELLI",
  url: "https://varelli.co.in/private-cinema-companies-bangalore",
      ...
      <section className="relative bg-[var(--surface-1)] border-b border-[var(--border)]">
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb items={[
            ...
            { name: "Private Cinema Companies in Bangalore — Dedicated Home Cinema Rooms", href: "/private-cinema-companies-bangalore" },
          ]} />
          <div className="mt-6 max-w-3xl">
            <h1 className="font-display text-[clamp(2.2rem,5vw,4rem)] font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Private Cinema Companies in Bangalore — Dedicated Home Cinema Rooms
            </h1>
