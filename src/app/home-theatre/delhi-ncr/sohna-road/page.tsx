...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Sohna Road, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Sohna Road, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/sohna-road"
})

export default function HomeTheatresohnaroadPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Sohna Road",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Sohna Road, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Sohna Road", href: "/home-theatre/delhi-ncr/sohna-road" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Sohna Road, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Sohna Road. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Sohna Road Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Sohna Road and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Sohna Road?",
