...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Chattarpur, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Chattarpur, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/chattarpur"
})

export default function HomeTheatrechattarpurPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Chattarpur",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Chattarpur", href: "/home-theatre/delhi-ncr/chattarpur" }
        ]} 
      />
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Chattarpur Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Chattarpur and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Chattarpur?",
