...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Golf Course Road, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Golf Course Road, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/golf-course-road"
})

export default function HomeTheatregolfcourseroadPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Golf Course Road",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Golf Course Road, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Golf Course Road", href: "/home-theatre/delhi-ncr/golf-course-road" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Golf Course Road, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Golf Course Road. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Golf Course Road Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Golf Course Road and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Golf Course Road?",
