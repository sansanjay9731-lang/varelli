...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Greater Kailash, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Greater Kailash, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/greater-kailash"
})

export default function HomeTheatregreaterkailashPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Greater Kailash",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Greater Kailash, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Greater Kailash", href: "/home-theatre/delhi-ncr/greater-kailash" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Greater Kailash, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Greater Kailash. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Greater Kailash Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Greater Kailash and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Greater Kailash?",
