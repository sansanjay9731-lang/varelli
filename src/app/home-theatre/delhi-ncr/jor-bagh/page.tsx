...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Jor Bagh, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Jor Bagh, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/jor-bagh"
})

export default function HomeTheatrejorbaghPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Jor Bagh",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Jor Bagh, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Jor Bagh", href: "/home-theatre/delhi-ncr/jor-bagh" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Jor Bagh, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Jor Bagh. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Jor Bagh Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Jor Bagh and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Jor Bagh?",
