...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Sundar Nagar, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Sundar Nagar, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/sundar-nagar"
})

export default function HomeTheatresundarnagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Sundar Nagar",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Sundar Nagar, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Sundar Nagar", href: "/home-theatre/delhi-ncr/sundar-nagar" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Sundar Nagar, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Sundar Nagar. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Sundar Nagar Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Sundar Nagar and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Sundar Nagar?",
