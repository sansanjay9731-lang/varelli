...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Panchsheel Park, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Panchsheel Park, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/panchsheel-park"
})

export default function HomeTheatrepanchsheelparkPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Panchsheel Park",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Panchsheel Park, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Panchsheel Park", href: "/home-theatre/delhi-ncr/panchsheel-park" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Panchsheel Park, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Panchsheel Park. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Panchsheel Park Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Panchsheel Park and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Panchsheel Park?",
