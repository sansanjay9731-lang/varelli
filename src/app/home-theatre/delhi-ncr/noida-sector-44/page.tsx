...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Noida Sector 44, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Noida Sector 44, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/noida-sector-44"
})

export default function HomeTheatrenoidasector44Page() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Noida Sector 44",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Noida Sector 44, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Noida Sector 44", href: "/home-theatre/delhi-ncr/noida-sector-44" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Noida Sector 44, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Noida Sector 44. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Noida Sector 44 Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Noida Sector 44 and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Noida Sector 44?",
