...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Lutyens Delhi, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Lutyens Delhi, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/lutyens-delhi"
})

export default function HomeTheatrelutyensdelhiPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Lutyens Delhi",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Lutyens Delhi, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Lutyens Delhi", href: "/home-theatre/delhi-ncr/lutyens-delhi" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Lutyens Delhi, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Lutyens Delhi. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Lutyens Delhi Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Lutyens Delhi and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Lutyens Delhi?",
