...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Defence Colony, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Defence Colony, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/defence-colony"
})

export default function HomeTheatredefencecolonyPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Defence Colony",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Defence Colony, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Defence Colony", href: "/home-theatre/delhi-ncr/defence-colony" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Defence Colony, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Defence Colony. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Defence Colony Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Defence Colony and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Defence Colony?",
