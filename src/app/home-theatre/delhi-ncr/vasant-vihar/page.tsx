...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Vasant Vihar, Delhi NCR — Dolby Atmos Installation | VARELLI",
  description: "Experience premium home theatre in Vasant Vihar, Delhi NCR. Custom Dolby Atmos and Reference Cinema installations for farmhouses, bungalows, and luxury apartments.",
  path: "/home-theatre/delhi-ncr/vasant-vihar"
})

export default function HomeTheatrevasantviharPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Home Theatre Installation in Vasant Vihar",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Vasant Vihar", href: "/home-theatre/delhi-ncr/vasant-vihar" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Theatre in Vasant Vihar, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Elevate your entertainment experience with a custom-designed home theatre in Vasant Vihar. 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Are you a home theatre company in Vasant Vihar Delhi?",
            answer: "Yes, VARELLI is a premium home theatre company serving Vasant Vihar and the wider Delhi NCR region. We specialize in custom installations."
          },
          {
          ...
          {
            question: "What is the typical home theatre cost in Vasant Vihar?",
