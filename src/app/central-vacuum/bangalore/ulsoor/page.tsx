...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Ulsoor, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Ulsoor, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/ulsoor",
  keywords: ["central vacuum Ulsoor bangalore", "built-in vacuum Ulsoor", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumUlsoorPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Ulsoor",
        "description": "Premium Drainvac central vacuum systems in Ulsoor, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Ulsoor, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Ulsoor."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Ulsoor, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Ulsoor." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Ulsoor", href: "/central-vacuum/bangalore/ulsoor" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Ulsoor, Bangalore — Drainvac</h1>
        
        <div className="prose max-w-none mb-12">
          <p>
            Experience the ultimate cleaning convenience for your luxury home in Ulsoor. Our Drainvac built-in central vacuum systems eliminate the need to lug heavy portable vacuums from room to room. With powerful suction and whisper-quiet operation, these systems reduce allergens and provide a deeper clean for your entire residence.
          </p>
        </div>

        <h2 className="text-3xl font-semibold mb-6">System Options for Ulsoor Homes</h2>
