...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Hebbal Kempapura, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Hebbal Kempapura, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/hebbal-kempapura",
  keywords: ["central vacuum Hebbal Kempapura bangalore", "built-in vacuum Hebbal Kempapura", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumHebbalKempapuraPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Hebbal Kempapura",
        "description": "Premium Drainvac central vacuum systems in Hebbal Kempapura, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Hebbal Kempapura, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Hebbal Kempapura."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Hebbal Kempapura, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Hebbal Kempapura." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Hebbal Kempapura", href: "/central-vacuum/bangalore/hebbal-kempapura" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Hebbal Kempapura, Bangalore — Drainvac</h1>
        
        <div className="prose prose-invert max-w-none text-[#C2C2C8] mb-12">
          <p>
            Experience the ultimate cleaning convenience for your luxury home in Hebbal Kempapura. Our Drainvac built-in central vacuum systems eliminate the need to lug heavy portable vacuums from room to room. With powerful suction and whisper-quiet operation, these systems reduce allergens and provide a deeper clean for your entire residence.
          </p>
        </div>

        <h2 className="text-3xl font-semibold mb-6">System Options for Hebbal Kempapura Homes</h2>
