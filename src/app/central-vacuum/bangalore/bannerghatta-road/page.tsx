...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Bannerghatta Road, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Bannerghatta Road, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/bannerghatta-road",
  keywords: ["central vacuum Bannerghatta Road bangalore", "built-in vacuum Bannerghatta Road", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumBannerghattaRoadPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Bannerghatta Road",
        "description": "Premium Drainvac central vacuum systems in Bannerghatta Road, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Bannerghatta Road, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Bannerghatta Road."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Bannerghatta Road, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Bannerghatta Road." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Bannerghatta Road", href: "/central-vacuum/bangalore/bannerghatta-road" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Bannerghatta Road, Bangalore — Drainvac</h1>
        
        <div className="prose prose-invert max-w-none text-[#C2C2C8] mb-12">
          <p>
            Experience the ultimate cleaning convenience for your luxury home in Bannerghatta Road. Our Drainvac built-in central vacuum systems eliminate the need to lug heavy portable vacuums from room to room. With powerful suction and whisper-quiet operation, these systems reduce allergens and provide a deeper clean for your entire residence.
          </p>
        </div>

        <h2 className="text-3xl font-semibold mb-6">System Options for Bannerghatta Road Homes</h2>
