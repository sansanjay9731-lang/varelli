...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Hebbal, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Hebbal, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/hebbal",
  keywords: ["central vacuum Hebbal bangalore", "built-in vacuum Hebbal", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumHebbalPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Hebbal",
        "description": "Premium Drainvac central vacuum systems in Hebbal, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Hebbal, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Hebbal."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Hebbal, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Hebbal." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Hebbal", href: "/central-vacuum/bangalore/hebbal" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Hebbal, Bangalore — Drainvac</h1>
        ...
        <h2 className="text-3xl font-semibold mb-6">System Options for Hebbal Homes</h2>
