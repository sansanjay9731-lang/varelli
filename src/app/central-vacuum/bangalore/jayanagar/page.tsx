...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Jayanagar, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Jayanagar, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/jayanagar",
  keywords: ["central vacuum Jayanagar bangalore", "built-in vacuum Jayanagar", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumJayanagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Jayanagar",
        "description": "Premium Drainvac central vacuum systems in Jayanagar, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Jayanagar, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Jayanagar."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Jayanagar, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Jayanagar." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Jayanagar", href: "/central-vacuum/bangalore/jayanagar" }
        ]}
      />
