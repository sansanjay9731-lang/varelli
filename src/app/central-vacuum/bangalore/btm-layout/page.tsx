...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Btm Layout, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Btm Layout, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/btm-layout",
  keywords: ["central vacuum Btm Layout bangalore", "built-in vacuum Btm Layout", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumBtmLayoutPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Btm Layout",
        "description": "Premium Drainvac central vacuum systems in Btm Layout, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Btm Layout, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Btm Layout."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Btm Layout, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Btm Layout." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Btm Layout", href: "/central-vacuum/bangalore/btm-layout" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Btm Layout, Bangalore — Drainvac</h1>
        
        <div className="prose max-w-none mb-12">
          <p>
            Experience the ultimate cleaning convenience for your luxury home in Btm Layout. Our Drainvac built-in central vacuum systems eliminate the need to lug heavy portable vacuums from room to room. With powerful suction and whisper-quiet operation, these systems reduce allergens and provide a deeper clean for your entire residence.
          </p>
        </div>

        <h2 className="text-3xl font-semibold mb-6">System Options for Btm Layout Homes</h2>
