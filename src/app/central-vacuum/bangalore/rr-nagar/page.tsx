...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum System in Rr Nagar, Bangalore — Drainvac Built-In | VARELLI",
  description: "Drainvac built-in central vacuum systems for luxury villas in Rr Nagar, Bangalore. Eliminates portable vacuums, reduces allergens, whisper-quiet operation.",
  path: "/central-vacuum/bangalore/rr-nagar",
  keywords: ["central vacuum Rr Nagar bangalore", "built-in vacuum Rr Nagar", "Drainvac bangalore", "central vacuum system bangalore"],
})

export default function CentralVacuumRrNagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Central Vacuum Rr Nagar",
        "description": "Premium Drainvac central vacuum systems in Rr Nagar, Bangalore.",
      ...
      },
      {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best central vacuum in Rr Nagar, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Rr Nagar."
            }
          },
          {
            "@type": "Question",
  ...
  const faqs = [
    { question: "What is the best central vacuum in Rr Nagar, Bangalore?", answer: "Drainvac offers powerful built-in vacuum solutions ideal for luxury homes in Rr Nagar." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Rr Nagar", href: "/central-vacuum/bangalore/rr-nagar" }
        ]}
      />
      
      <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8">Built-In Central Vacuum System in Rr Nagar, Bangalore — Drainvac</h1>
        
        <div className="prose prose-invert max-w-none text-[#C2C2C8] mb-12">
          <p>
            Experience the ultimate cleaning convenience for your luxury home in Rr Nagar. Our Drainvac built-in central vacuum systems eliminate the need to lug heavy portable vacuums from room to room. With powerful suction and whisper-quiet operation, these systems reduce allergens and provide a deeper clean for your entire residence.
          </p>
        </div>

        <h2 className="text-3xl font-semibold mb-6">System Options for Rr Nagar Homes</h2>
