...
export function generateMetadata(): Metadata {
  return generatePageMetadata({
    title: 'Home Theatre Company in Indiranagar, Bangalore — Dolby Atmos | VARELLI',
    description: 'Top-rated home theatre company in Indiranagar, Bangalore. Experience Dolby Atmos surround sound with premium brands.',
    path: '/home-theatre-company-indiranagar-bangalore'
  })
}
...
export default function HomeTheatreCompanyPage() {
  const schema = {
    ...
    "name": "VARELLI - Home Theatre Company Indiranagar",
    "description": "Premium home theatre design and installation in Indiranagar, Bangalore.",
    "mainEntity": [
      {
        "@type": "Question",
        "name": "best home theatre company indiranagar bangalore",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "VARELLI offers bespoke home theatre design and installation in Indiranagar, featuring top brands like Sonus Faber and KEF."
        }
      },
      {
        "@type": "Question",
        "name": "home theatre installation cost indiranagar",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "dolby atmos indiranagar bangalore",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "VARELLI designs and installs custom Dolby Atmos home theatres in Indiranagar."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <main className="bg-black text-white min-h-screen">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Home Theatre Company in Indiranagar, Bangalore</h1>
          
          <h2 className="text-2xl md:text-3xl font-semibold mb-6">Why VARELLI Is Indiranagar&apos;s Best Home Theatre Company</h2>
          ...
          <div className="mb-12">
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li><Link href={`/private-cinema/bangalore/indiranagar`} className="text-blue-400 hover:underline">Private Cinema in Indiranagar</Link></li>
            </ul>
          </div>
