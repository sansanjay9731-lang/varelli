...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Cost in Electronic City, Bangalore 2026 — ₹8L to ₹85L Price Guide",
  description: "Comprehensive guide to home theatre costs in Electronic City, Bangalore. Budgeting for 5.1, Dolby Atmos, and dedicated reference cinema rooms.",
  path: "/journal/home-theatre-cost-electronic-city-bangalore",
})
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "Home Theatre Cost in Electronic City, Bangalore 2026",
      "description": "Comprehensive guide to home theatre costs in Electronic City, Bangalore.",
      "author": {
        "@type": "Organization",
        "name": "VARELLI"
      }
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the home theatre cost in Electronic City Bangalore?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A good quality home theatre in Electronic City starts at ₹8 Lakhs for a basic living room setup and scales up to ₹85 Lakhs or more for a dedicated reference cinema."
          }
        },
        {
          "@type": "Question",
          "name": "How much does a Dolby Atmos setup cost in Electronic City?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "What is the average home theatre price in Electronic City Bangalore?",
          "acceptedAnswer": {
            "@type": "Answer",
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-invert">
          <h1>Home Theatre Cost in Electronic City, Bangalore 2026</h1>
          
          <p>
            Building a home theatre in Electronic City, Bangalore is an investment in pure entertainment. 
          ...
          <h2>Room Context in Electronic City</h2>
          <p>
            In Electronic City, space is a premium. Apartment dwellers often opt for media room setups integrated into the main living space. 
          ...
          <p>
            To learn more about local installations, visit our <Link href={`/home-theatre/bangalore/electronic-city`} className="text-[#c5a059] hover:underline">Home Theatre services in Electronic City</Link>.
          </p>
        </article>
      </main>
