...
export const metadata: Metadata = generatePageMetadata({
  title: "Motorized Curtains & Blinds in Bangalore — KNX-Integrated Smart Shading Systems | VARELLI",
  description: "Comprehensive guide to motorized curtain blinds bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/motorized-curtain-blinds-bangalore",
  keywords: ["motorized curtain blinds bangalore", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Motorized Curtains & Blinds in Bangalore — KNX-Integrated Smart Shading Systems",
  description: "Comprehensive guide to motorized curtain blinds bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/motorized-curtain-blinds-bangalore`,
};

const faqs = [
  {
    question: "What does VARELLI offer for motorized curtain blinds bangalore?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Motorized Curtains & Blinds in Bangalore — KNX-Int...", href: "/journal/motorized-curtain-blinds-bangalore" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Motorized Curtains & Blinds in Bangalore — KNX-Integrated Smart Shading Systems
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to motorized curtain blinds bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Motorized Curtains & Blinds in Bangalore — KNX-Integrated Smart Shading Systems — Frequently Asked Questions"} />
