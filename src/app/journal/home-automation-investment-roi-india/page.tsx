...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home ROI in India — Does Home Automation Increase Property Value? | VARELLI",
  description: "Comprehensive guide to home automation investment roi india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-investment-roi-india",
  keywords: ["home automation investment roi india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home ROI in India — Does Home Automation Increase Property Value?",
  description: "Comprehensive guide to home automation investment roi india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-investment-roi-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation investment roi india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home ROI in India — Does Home Automation Inc...", href: "/journal/home-automation-investment-roi-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home ROI in India — Does Home Automation Increase Property Value?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation investment roi india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home ROI in India — Does Home Automation Increase Property Value? — Frequently Asked Questions"} />
