...
export const metadata: Metadata = generatePageMetadata({
  title: "DALI-2 Lighting Control in Bangalore — Circadian Lighting for Luxury Indian Homes | VARELLI",
  description: "Comprehensive guide to dali 2 lighting bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/dali-2-lighting-bangalore",
  keywords: ["dali 2 lighting bangalore", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "DALI-2 Lighting Control in Bangalore — Circadian Lighting for Luxury Indian Homes",
  description: "Comprehensive guide to dali 2 lighting bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/dali-2-lighting-bangalore`,
};

const faqs = [
  {
    question: "What does VARELLI offer for dali 2 lighting bangalore?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "DALI-2 Lighting Control in Bangalore — Circadian L...", href: "/journal/dali-2-lighting-bangalore" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              DALI-2 Lighting Control in Bangalore — Circadian Lighting for Luxury Indian Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to dali 2 lighting bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"DALI-2 Lighting Control in Bangalore — Circadian Lighting for Luxury Indian Homes — Frequently Asked Questions"} />
