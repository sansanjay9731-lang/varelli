...
export const metadata: Metadata = generatePageMetadata({
  title: "KNX vs Control4 in India — Which Smart Home System is Right for Your Luxury Residence? | VARELLI",
  description: "Comprehensive guide to knx vs control4 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/knx-vs-control4-india",
  keywords: ["knx vs control4 india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "KNX vs Control4 in India — Which Smart Home System is Right for Your Luxury Residence?",
  description: "Comprehensive guide to knx vs control4 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/knx-vs-control4-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for knx vs control4 india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "KNX vs Control4 in India — Which Smart Home System...", href: "/journal/knx-vs-control4-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              KNX vs Control4 in India — Which Smart Home System is Right for Your Luxury Residence?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to knx vs control4 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"KNX vs Control4 in India — Which Smart Home System is Right for Your Luxury Residence? — Frequently Asked Questions"} />
