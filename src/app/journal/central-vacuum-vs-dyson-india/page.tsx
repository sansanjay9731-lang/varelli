...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum vs Dyson vs Robot Vacuum for Large Indian Homes — Complete Comparison | VARELLI",
  description: "Comprehensive guide to central vacuum vs dyson india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/central-vacuum-vs-dyson-india",
  keywords: ["central vacuum vs dyson india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Central Vacuum vs Dyson vs Robot Vacuum for Large Indian Homes — Complete Comparison",
  description: "Comprehensive guide to central vacuum vs dyson india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/central-vacuum-vs-dyson-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for central vacuum vs dyson india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Central Vacuum vs Dyson vs Robot Vacuum for Large ...", href: "/journal/central-vacuum-vs-dyson-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Central Vacuum vs Dyson vs Robot Vacuum for Large Indian Homes — Complete Comparison
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to central vacuum vs dyson india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Central Vacuum vs Dyson vs Robot Vacuum for Large Indian Homes — Complete Comparison — Frequently Asked Questions"} />
