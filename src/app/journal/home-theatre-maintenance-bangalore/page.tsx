...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Maintenance & AMC in Bangalore",
  description: "Comprehensive guide to Home Theatre Maintenance & AMC in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-maintenance-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Maintenance & AMC in Bangalore",
        "description": "Comprehensive guide to Home Theatre Maintenance & AMC in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
