...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/central-vacuum-cost-india-2026",
title: "Central Vacuum System Cost in India 2026 — Installation Pricing for Indian Homes",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/central-vacuum-cost-india-2026" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Central Vacuum System Cost in India 2026 — Installation Pricing for Indian Homes</h1>
          ...
          <div className="content">
            ...
            <p>Drainvac system pricing, installation by sq.ft., comparison to robot vacuums</p>
