...
export const metadata: Metadata = generatePageMetadata({
  title: "Basalte vs Ekinex Keypads in India — Comparing the World\'s Two Finest KNX Interfaces | VARELLI",
  description: "Comprehensive guide to basalte vs ekinex india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/basalte-vs-ekinex-india",
  keywords: ["basalte vs ekinex india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Basalte vs Ekinex Keypads in India — Comparing the World\'s Two Finest KNX Interfaces",
  description: "Comprehensive guide to basalte vs ekinex india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/basalte-vs-ekinex-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for basalte vs ekinex india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Basalte vs Ekinex Keypads in India — Comparing the...", href: "/journal/basalte-vs-ekinex-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Basalte vs Ekinex Keypads in India — Comparing the World\'s Two Finest KNX Interfaces
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to basalte vs ekinex india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Basalte vs Ekinex Keypads in India — Comparing the World\'s Two Finest KNX Interfaces — Frequently Asked Questions"} />
