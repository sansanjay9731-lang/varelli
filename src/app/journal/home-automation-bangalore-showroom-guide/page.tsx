...
export const metadata: Metadata = generatePageMetadata({
  title: "Best Home Automation Experience Centers and Showrooms in Bangalore",
  ...
  path: "/journal/home-automation-bangalore-showroom-guide"
})
...
export default function JournalArticle() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Best Home Automation Experience Centers and Showrooms in Bangalore",
        "author": {
          "@type": "Organization",
          "name": "Varelli"
        },
    ...
    <article className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="mb-10 text-center">
        <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-4">
          Best Home Automation Experience Centers and Showrooms in Bangalore
        </h1>
      ...
      <div className="prose prose-lg mx-auto max-w-none text-[#C2C2C8]">
        ...
        <h2 className="text-3xl font-bold text-white mt-12 mb-6">Why Choose KNX for Your Bangalore Home?</h2>
        <p>
        ...
        <h2 className="text-3xl font-bold text-white mt-12 mb-6">Home Automation Cost in Bangalore</h2>
        <p className="mb-6">
        ...
        <div className="mt-8 mb-12">
          <p>
            ...
            <Link href="/home-automation/bangalore/bangalore-showroom" className="text-[#C5A880] hover:text-[#d8ba91] underline">
              Bangalore
            </Link>.
          </p>
        </div>
