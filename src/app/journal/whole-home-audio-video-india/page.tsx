...
export const metadata: Metadata = generatePageMetadata({
  title: "Whole-Home Audio Video Distribution in India — Every Room, One Ecosystem | VARELLI",
  description: "Comprehensive guide to whole home audio video india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/whole-home-audio-video-india",
  keywords: ["whole home audio video india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Whole-Home Audio Video Distribution in India — Every Room, One Ecosystem",
  description: "Comprehensive guide to whole home audio video india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/whole-home-audio-video-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for whole home audio video india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Whole-Home Audio Video Distribution in India — Eve...", href: "/journal/whole-home-audio-video-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Whole-Home Audio Video Distribution in India — Every Room, One Ecosystem
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to whole home audio video india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Whole-Home Audio Video Distribution in India — Every Room, One Ecosystem — Frequently Asked Questions"} />
