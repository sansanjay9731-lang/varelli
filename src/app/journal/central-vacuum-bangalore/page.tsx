...
export const metadata: Metadata = generatePageMetadata({
  title: "Central Vacuum Systems in Bangalore — Built-In Drainvac for Luxury Villas | VARELLI",
  description: "Comprehensive guide to central vacuum bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/central-vacuum-bangalore",
  keywords: ["central vacuum bangalore", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Central Vacuum Systems in Bangalore — Built-In Drainvac for Luxury Villas",
  description: "Comprehensive guide to central vacuum bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/central-vacuum-bangalore`,
};

const faqs = [
  {
    question: "What does VARELLI offer for central vacuum bangalore?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Central Vacuum Systems in Bangalore — Built-In Dra...", href: "/journal/central-vacuum-bangalore" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Central Vacuum Systems in Bangalore — Built-In Drainvac for Luxury Villas
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to central vacuum bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Central Vacuum Systems in Bangalore — Built-In Drainvac for Luxury Villas — Frequently Asked Questions"} />
