...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Warranty & After-Sales Service in India — What You Need to Know | VARELLI",
  description: "Comprehensive guide to smart home warranty india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/smart-home-warranty-india",
  keywords: ["smart home warranty india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Warranty & After-Sales Service in India — What You Need to Know",
  description: "Comprehensive guide to smart home warranty india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/smart-home-warranty-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for smart home warranty india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Warranty & After-Sales Service in India...", href: "/journal/smart-home-warranty-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Warranty & After-Sales Service in India — What You Need to Know
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to smart home warranty india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Warranty & After-Sales Service in India — What You Need to Know — Frequently Asked Questions"} />
