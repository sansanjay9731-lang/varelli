...
export const metadata: Metadata = generatePageMetadata({
  title: "Crestron vs Savant Home Automation in India — Which Premium Control System Wins? | VARELLI",
  description: "Comprehensive guide to crestron vs savant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/crestron-vs-savant-india",
  keywords: ["crestron vs savant india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Crestron vs Savant Home Automation in India — Which Premium Control System Wins?",
  description: "Comprehensive guide to crestron vs savant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/crestron-vs-savant-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for crestron vs savant india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Crestron vs Savant Home Automation in India — Whic...", href: "/journal/crestron-vs-savant-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Crestron vs Savant Home Automation in India — Which Premium Control System Wins?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to crestron vs savant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Crestron vs Savant Home Automation in India — Which Premium Control System Wins? — Frequently Asked Questions"} />
