...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Room Design in Bangalore — Acoustic & AV Layout",
  description: "Comprehensive guide to Home Theatre Room Design in Bangalore — Acoustic & AV Layout. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-room-design-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Room Design in Bangalore — Acoustic & AV Layout",
        "description": "Comprehensive guide to Home Theatre Room Design in Bangalore — Acoustic & AV Layout.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
