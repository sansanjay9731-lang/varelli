...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Companies in Bangalore — How to Compare 2026",
  description: "Comprehensive guide to Home Theatre Companies in Bangalore — How to Compare 2026. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-companies-bangalore-comparison"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Companies in Bangalore — How to Compare 2026",
        "description": "Comprehensive guide to Home Theatre Companies in Bangalore — How to Compare 2026.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
