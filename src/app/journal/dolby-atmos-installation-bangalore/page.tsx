...
export const metadata: Metadata = generatePageMetadata({
  title: "Dolby Atmos Installation in Bangalore — Complete Setup Guide",
  description: "Comprehensive guide to Dolby Atmos Installation in Bangalore — Complete Setup Guide. Discover the best setups, acoustics, and technologies.",
  path: "/journal/dolby-atmos-installation-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Dolby Atmos Installation in Bangalore — Complete Setup Guide",
        "description": "Comprehensive guide to Dolby Atmos Installation in Bangalore — Complete Setup Guide.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            Explore our broader <Link href="/home-theatre/bangalore" className="text-blue-600 underline">Bangalore home theatre services</Link>.
          </p>
