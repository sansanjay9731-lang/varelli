...
export const metadata: Metadata = generatePageMetadata({
  title: "Basalte Keypads in India — The World's Most Luxurious Smart Switch Explained | VARELLI",
  description: "Comprehensive guide to basalte keypad india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/basalte-keypad-india-guide",
  keywords: ["basalte keypad india guide", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Basalte Keypads in India — The World's Most Luxurious Smart Switch Explained",
  description: "Comprehensive guide to basalte keypad india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/basalte-keypad-india-guide`,
};

const faqs = [
  {
    question: "What does VARELLI offer for basalte keypad india guide?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Basalte Keypads in India — The World's Most Luxuri...", href: "/journal/basalte-keypad-india-guide" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Basalte Keypads in India — The World's Most Luxurious Smart Switch Explained
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to basalte keypad india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Basalte Keypads in India — The World's Most Luxurious Smart Switch Explained — Frequently Asked Questions"} />
