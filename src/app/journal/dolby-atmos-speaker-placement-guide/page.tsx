...
export const metadata: Metadata = generatePageMetadata({
  title: "Dolby Atmos Speaker Placement Guide for Indian Home Theatre Rooms | VARELLI",
  description: "Comprehensive guide to dolby atmos speaker placement guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/dolby-atmos-speaker-placement-guide",
  keywords: ["dolby atmos speaker placement guide", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Dolby Atmos Speaker Placement Guide for Indian Home Theatre Rooms",
  description: "Comprehensive guide to dolby atmos speaker placement guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/dolby-atmos-speaker-placement-guide`,
};

const faqs = [
  {
    question: "What does VARELLI offer for dolby atmos speaker placement guide?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Dolby Atmos Speaker Placement Guide for Indian Hom...", href: "/journal/dolby-atmos-speaker-placement-guide" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Dolby Atmos Speaker Placement Guide for Indian Home Theatre Rooms
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to dolby atmos speaker placement guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Dolby Atmos Speaker Placement Guide for Indian Home Theatre Rooms — Frequently Asked Questions"} />
