...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide | VARELLI Journal",
  description: "Read our comprehensive guide: Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/home-theatre-installation-bangalore-cost",
  keywords: ["home theatre installation cost in bangalore 2026 — full price guide", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide",
    "description": "Read our comprehensive guide: Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/home-theatre-installation-bangalore-cost' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide
          </h1>
        ...
        <div className="prose prose-lg max-w-none mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>Home Theatre Installation Cost in Bangalore 2026 — Full Price Guide</strong>, aims to clarify this landscape.
          </p>
          <p>
