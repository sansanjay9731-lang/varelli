...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/smart-security-cost-india-2026",
title: "Smart Home Security System Cost in India 2026 — Cameras, DoorBird & Access Control Pricing",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/smart-security-cost-india-2026" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Smart Home Security System Cost in India 2026 — Cameras, DoorBird & Access Control Pricing</h1>
