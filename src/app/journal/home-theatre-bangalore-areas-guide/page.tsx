...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Installation Across Bangalore — Area-Wise Guide | VARELLI Journal",
  description: "Read our comprehensive guide: Home Theatre Installation Across Bangalore — Area-Wise Guide. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/home-theatre-bangalore-areas-guide",
  keywords: ["home theatre installation across bangalore — area-wise guide", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Home Theatre Installation Across Bangalore — Area-Wise Guide",
    "description": "Read our comprehensive guide: Home Theatre Installation Across Bangalore — Area-Wise Guide. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/home-theatre-bangalore-areas-guide' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Home Theatre Installation Across Bangalore — Area-Wise Guide
          </h1>
        ...
        <div className="prose prose-lg max-w-none mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>Home Theatre Installation Across Bangalore — Area-Wise Guide</strong>, aims to clarify this landscape.
          </p>
          <p>
