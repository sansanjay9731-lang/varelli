...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/kef-speakers-india-price",
title: "KEF Speakers in India 2026 — Pricing Guide for Home Theatre & Multi-Room Audio",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/kef-speakers-india-price" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">KEF Speakers in India 2026 — Pricing Guide for Home Theatre & Multi-Room Audio</h1>
          ...
          <div className="content">
            ...
            <p>Reference Series, Blade, Ci in-wall, India pricing, why KEF for home cinema</p>
