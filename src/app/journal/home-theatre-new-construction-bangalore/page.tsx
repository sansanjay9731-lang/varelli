...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Planning for New Construction in Bangalore",
  description: "Comprehensive guide to Home Theatre Planning for New Construction in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-new-construction-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Planning for New Construction in Bangalore",
        "description": "Comprehensive guide to Home Theatre Planning for New Construction in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
