...
export const metadata: Metadata = generatePageMetadata({
  title: "10 Questions to Ask Your Home Automation Integrator in India Before Signing | VARELLI",
  description: "Comprehensive guide to home automation questions to ask integrator for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-questions-to-ask-integrator",
  keywords: ["home automation questions to ask integrator", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "10 Questions to Ask Your Home Automation Integrator in India Before Signing",
  description: "Comprehensive guide to home automation questions to ask integrator for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-questions-to-ask-integrator`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation questions to ask integrator?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "10 Questions to Ask Your Home Automation Integrato...", href: "/journal/home-automation-questions-to-ask-integrator" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              10 Questions to Ask Your Home Automation Integrator in India Before Signing
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation questions to ask integrator for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"10 Questions to Ask Your Home Automation Integrator in India Before Signing — Frequently Asked Questions"} />
