...
export const metadata: Metadata = generatePageMetadata({
  title: "Lutron vs DALI-2 Lighting Control for India — Which Protocol Wins for Luxury Homes? | VARELLI",
  description: "Comprehensive guide to lutron vs dali 2 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/lutron-vs-dali-2-india",
  keywords: ["lutron vs dali 2 india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Lutron vs DALI-2 Lighting Control for India — Which Protocol Wins for Luxury Homes?",
  description: "Comprehensive guide to lutron vs dali 2 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/lutron-vs-dali-2-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for lutron vs dali 2 india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Lutron vs DALI-2 Lighting Control for India — Whic...", href: "/journal/lutron-vs-dali-2-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Lutron vs DALI-2 Lighting Control for India — Which Protocol Wins for Luxury Homes?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to lutron vs dali 2 india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Lutron vs DALI-2 Lighting Control for India — Which Protocol Wins for Luxury Homes? — Frequently Asked Questions"} />
