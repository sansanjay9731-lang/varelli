  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg mx-auto max-w-none text-[#C2C2C8]">
        ...
        <h2 className="text-3xl font-bold text-white mt-12 mb-6">Why Choose KNX for Your Yelahanka Home?</h2>
        <p>
        ...
        <h2 className="text-3xl font-bold text-white mt-12 mb-6">Home Automation Cost in Yelahanka</h2>
        <p className="mb-6">
        ...
        <div className="mt-8 mb-12">
          <p>
            ...
            <Link href="/home-automation/bangalore/yelahanka-bangalore" className="text-[#C5A880] hover:text-[#d8ba91] underline">
              Yelahanka
            </Link>.
          </p>
        </div>
