...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/home-theatre-cost-bangalore-2026",
title: "Home Theatre Cost in Bangalore 2026 — Equipment, Installation & Room Build Pricing",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/home-theatre-cost-bangalore-2026" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Home Theatre Cost in Bangalore 2026 — Equipment, Installation & Room Build Pricing</h1>
