...
export const metadata: Metadata = generatePageMetadata({
  title: "How to Design a Private Home Cinema in India — Complete Architect's Guide 2026 | VARELLI",
  description: "Comprehensive guide to how to design private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/how-to-design-private-cinema-india",
  keywords: ["how to design private cinema india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "How to Design a Private Home Cinema in India — Complete Architect's Guide 2026",
  description: "Comprehensive guide to how to design private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/how-to-design-private-cinema-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for how to design private cinema india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "How to Design a Private Home Cinema in India — Com...", href: "/journal/how-to-design-private-cinema-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              How to Design a Private Home Cinema in India — Complete Architect's Guide 2026
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to how to design private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"How to Design a Private Home Cinema in India — Complete Architect's Guide 2026 — Frequently Asked Questions"} />
