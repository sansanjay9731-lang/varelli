...
export const metadata: Metadata = generatePageMetadata({
  title: "KNX vs Lutron for Home Automation in India — Which Lighting & Control System is Best? | VARELLI",
  description: "Comprehensive guide to knx vs lutron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/knx-vs-lutron-india",
  keywords: ["knx vs lutron india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "KNX vs Lutron for Home Automation in India — Which Lighting & Control System is Best?",
  description: "Comprehensive guide to knx vs lutron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/knx-vs-lutron-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for knx vs lutron india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "KNX vs Lutron for Home Automation in India — Which...", href: "/journal/knx-vs-lutron-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              KNX vs Lutron for Home Automation in India — Which Lighting & Control System is Best?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to knx vs lutron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"KNX vs Lutron for Home Automation in India — Which Lighting & Control System is Best? — Frequently Asked Questions"} />
