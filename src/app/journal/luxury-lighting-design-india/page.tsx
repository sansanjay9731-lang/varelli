...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Lighting Design in India — DALI-2 Circadian Tunable White for Wellbeing | VARELLI",
  description: "Comprehensive guide to luxury lighting design india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/luxury-lighting-design-india",
  keywords: ["luxury lighting design india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Luxury Lighting Design in India — DALI-2 Circadian Tunable White for Wellbeing",
  description: "Comprehensive guide to luxury lighting design india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/luxury-lighting-design-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for luxury lighting design india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Luxury Lighting Design in India — DALI-2 Circadian...", href: "/journal/luxury-lighting-design-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Luxury Lighting Design in India — DALI-2 Circadian Tunable White for Wellbeing
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to luxury lighting design india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Luxury Lighting Design in India — DALI-2 Circadian Tunable White for Wellbeing — Frequently Asked Questions"} />
