...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Automation in Chennai — KNX Systems for Boat Club Road & ECR Residences | VARELLI",
  description: "Comprehensive guide to home automation chennai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-chennai",
  keywords: ["home automation chennai", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Automation in Chennai — KNX Systems for Boat Club Road & ECR Residences",
  description: "Comprehensive guide to home automation chennai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-chennai`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation chennai?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Automation in Chennai — KNX Systems for...", href: "/journal/home-automation-chennai" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Automation in Chennai — KNX Systems for Boat Club Road & ECR Residences
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation chennai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Automation in Chennai — KNX Systems for Boat Club Road & ECR Residences — Frequently Asked Questions"} />
