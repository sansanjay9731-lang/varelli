...
export const metadata: Metadata = generatePageMetadata({
  title: "JBL Synthesis Home Theatre in Bangalore",
  description: "Comprehensive guide to JBL Synthesis Home Theatre in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/jbl-synthesis-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "JBL Synthesis Home Theatre in Bangalore",
        "description": "Comprehensive guide to JBL Synthesis Home Theatre in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
