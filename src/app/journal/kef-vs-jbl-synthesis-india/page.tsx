...
export const metadata: Metadata = generatePageMetadata({
  title: "KEF vs JBL Synthesis for Home Theatre India — Studio Monitor vs Audiophile Sound | VARELLI",
  description: "Comprehensive guide to kef vs jbl synthesis india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/kef-vs-jbl-synthesis-india",
  keywords: ["kef vs jbl synthesis india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "KEF vs JBL Synthesis for Home Theatre India — Studio Monitor vs Audiophile Sound",
  description: "Comprehensive guide to kef vs jbl synthesis india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/kef-vs-jbl-synthesis-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for kef vs jbl synthesis india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "KEF vs JBL Synthesis for Home Theatre India — Stud...", href: "/journal/kef-vs-jbl-synthesis-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              KEF vs JBL Synthesis for Home Theatre India — Studio Monitor vs Audiophile Sound
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to kef vs jbl synthesis india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"KEF vs JBL Synthesis for Home Theatre India — Studio Monitor vs Audiophile Sound — Frequently Asked Questions"} />
