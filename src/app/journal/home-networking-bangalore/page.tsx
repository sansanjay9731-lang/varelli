...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Networking in Bangalore — UniFi Wi-Fi 6E & Structured Cabling for Luxury Residences | VARELLI",
  description: "Comprehensive guide to home networking bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-networking-bangalore",
  keywords: ["home networking bangalore", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Home Networking in Bangalore — UniFi Wi-Fi 6E & Structured Cabling for Luxury Residences",
  description: "Comprehensive guide to home networking bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-networking-bangalore`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home networking bangalore?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Home Networking in Bangalore — UniFi Wi-Fi 6E & St...", href: "/journal/home-networking-bangalore" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Networking in Bangalore — UniFi Wi-Fi 6E & Structured Cabling for Luxury Residences
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home networking bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Home Networking in Bangalore — UniFi Wi-Fi 6E & Structured Cabling for Luxury Residences — Frequently Asked Questions"} />
