...
export const metadata: Metadata = generatePageMetadata({
  title: "Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide | VARELLI Journal",
  description: "Read our comprehensive guide: Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/dolby-atmos-home-theatre-bangalore",
  keywords: ["dolby atmos home theatre in bangalore — professional installation guide", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide",
    "description": "Read our comprehensive guide: Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/dolby-atmos-home-theatre-bangalore' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide
          </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none text-[#C2C2C8] mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>Dolby Atmos Home Theatre in Bangalore — Professional Installation Guide</strong>, aims to clarify this landscape.
          </p>
          <p>
