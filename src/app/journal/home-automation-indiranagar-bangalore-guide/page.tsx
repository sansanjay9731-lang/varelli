  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg mx-auto max-w-none text-gray-700">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Why Choose KNX for Your Indiranagar Home?</h2>
        <p>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-6">Home Automation Cost in Indiranagar</h2>
        <p className="mb-6">
        ...
        <div className="mt-8 mb-12">
          <p>
            ...
            <Link href="/home-automation/bangalore/indiranagar-bangalore" className="text-blue-600 hover:text-blue-800 underline">
              Indiranagar
            </Link>.
          </p>
        </div>
