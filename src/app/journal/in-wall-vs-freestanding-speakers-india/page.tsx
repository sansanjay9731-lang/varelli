...
export const metadata: Metadata = generatePageMetadata({
  title: "In-Wall vs Freestanding Speakers for Home Theatre India — Architecture vs Performance | VARELLI",
  description: "Comprehensive guide to in wall vs freestanding speakers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/in-wall-vs-freestanding-speakers-india",
  keywords: ["in wall vs freestanding speakers india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "In-Wall vs Freestanding Speakers for Home Theatre India — Architecture vs Performance",
  description: "Comprehensive guide to in wall vs freestanding speakers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/in-wall-vs-freestanding-speakers-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for in wall vs freestanding speakers india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "In-Wall vs Freestanding Speakers for Home Theatre ...", href: "/journal/in-wall-vs-freestanding-speakers-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              In-Wall vs Freestanding Speakers for Home Theatre India — Architecture vs Performance
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to in wall vs freestanding speakers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"In-Wall vs Freestanding Speakers for Home Theatre India — Architecture vs Performance — Frequently Asked Questions"} />
