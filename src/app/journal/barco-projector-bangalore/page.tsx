...
export const metadata: Metadata = generatePageMetadata({
  title: "Barco 4K Laser Projector in Bangalore",
  description: "Comprehensive guide to Barco 4K Laser Projector in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/barco-projector-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Barco 4K Laser Projector in Bangalore",
        "description": "Comprehensive guide to Barco 4K Laser Projector in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
