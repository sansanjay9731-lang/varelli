      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            For more localized options, explore our <Link href="/home-theatre/bangalore/richmond-town" className="text-[#C5A880] underline">Home Theatre in Bangalore Richmond Town</Link> guide, or view our broader <Link href="/home-theatre/bangalore" className="text-[#C5A880] underline">Bangalore home theatre services</Link>.
          </p>
