...
export const metadata: Metadata = generatePageMetadata({
  title: "What Is KNX Home Automation? The Complete 2026 Guide for Indian Homeowners | VARELLI",
  description: "Comprehensive guide to what is knx home automation for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/what-is-knx-home-automation",
  keywords: ["what is knx home automation", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "What Is KNX Home Automation? The Complete 2026 Guide for Indian Homeowners",
  description: "Comprehensive guide to what is knx home automation for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/what-is-knx-home-automation`,
};

const faqs = [
  {
    question: "What does VARELLI offer for what is knx home automation?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "What Is KNX Home Automation? The Complete 2026 Gui...", href: "/journal/what-is-knx-home-automation" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              What Is KNX Home Automation? The Complete 2026 Guide for Indian Homeowners
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to what is knx home automation for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"What Is KNX Home Automation? The Complete 2026 Guide for Indian Homeowners — Frequently Asked Questions"} />
