...
export const metadata: Metadata = generatePageMetadata({
  title: "KNX vs Crestron for Home Automation in India — Architecture-Led Comparison 2026 | VARELLI",
  description: "Comprehensive guide to knx vs crestron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/knx-vs-crestron-india",
  keywords: ["knx vs crestron india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "KNX vs Crestron for Home Automation in India — Architecture-Led Comparison 2026",
  description: "Comprehensive guide to knx vs crestron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/knx-vs-crestron-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for knx vs crestron india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "KNX vs Crestron for Home Automation in India — Arc...", href: "/journal/knx-vs-crestron-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              KNX vs Crestron for Home Automation in India — Architecture-Led Comparison 2026
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to knx vs crestron india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"KNX vs Crestron for Home Automation in India — Architecture-Led Comparison 2026 — Frequently Asked Questions"} />
