...
export const metadata: Metadata = generatePageMetadata({
  title: "Barco vs Sony Laser Projector for Home Cinema India — Which 4K Projector is Best? | VARELLI",
  description: "Comprehensive guide to barco vs sony projector india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/barco-vs-sony-projector-india",
  keywords: ["barco vs sony projector india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Barco vs Sony Laser Projector for Home Cinema India — Which 4K Projector is Best?",
  description: "Comprehensive guide to barco vs sony projector india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/barco-vs-sony-projector-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for barco vs sony projector india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Barco vs Sony Laser Projector for Home Cinema Indi...", href: "/journal/barco-vs-sony-projector-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Barco vs Sony Laser Projector for Home Cinema India — Which 4K Projector is Best?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to barco vs sony projector india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Barco vs Sony Laser Projector for Home Cinema India — Which 4K Projector is Best? — Frequently Asked Questions"} />
