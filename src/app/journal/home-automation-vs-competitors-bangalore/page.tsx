...
export const metadata: Metadata = generatePageMetadata({
  title: "KNX vs Cheaper Home Automation in Bangalore — What to Know | VARELLI Journal",
  description: "Read our comprehensive guide: KNX vs Cheaper Home Automation in Bangalore — What to Know. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/home-automation-vs-competitors-bangalore",
  keywords: ["knx vs cheaper home automation in bangalore — what to know", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "KNX vs Cheaper Home Automation in Bangalore — What to Know",
    "description": "Read our comprehensive guide: KNX vs Cheaper Home Automation in Bangalore — What to Know. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/home-automation-vs-competitors-bangalore' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            KNX vs Cheaper Home Automation in Bangalore — What to Know
          </h1>
        ...
        <div className="prose prose-lg max-w-none mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>KNX vs Cheaper Home Automation in Bangalore — What to Know</strong>, aims to clarify this landscape.
          </p>
          <p>
