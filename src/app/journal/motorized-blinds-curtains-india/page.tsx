...
export const metadata: Metadata = generatePageMetadata({
  title: "Motorized Blinds & Curtains in India — KNX-Integrated Smart Shading for Luxury Homes | VARELLI",
  description: "Comprehensive guide to motorized blinds curtains india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/motorized-blinds-curtains-india",
  keywords: ["motorized blinds curtains india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Motorized Blinds & Curtains in India — KNX-Integrated Smart Shading for Luxury Homes",
  description: "Comprehensive guide to motorized blinds curtains india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/motorized-blinds-curtains-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for motorized blinds curtains india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Motorized Blinds & Curtains in India — KNX-Integra...", href: "/journal/motorized-blinds-curtains-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Motorized Blinds & Curtains in India — KNX-Integrated Smart Shading for Luxury Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to motorized blinds curtains india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Motorized Blinds & Curtains in India — KNX-Integrated Smart Shading for Luxury Homes — Frequently Asked Questions"} />
