...
export const metadata: Metadata = generatePageMetadata({
  title: "4K Home Theatre in Bangalore — Barco Laser vs OLED",
  description: "Comprehensive guide to 4K Home Theatre in Bangalore — Barco Laser vs OLED. Discover the best setups, acoustics, and technologies.",
  path: "/journal/4k-home-theatre-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "4K Home Theatre in Bangalore — Barco Laser vs OLED",
        "description": "Comprehensive guide to 4K Home Theatre in Bangalore — Barco Laser vs OLED.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
