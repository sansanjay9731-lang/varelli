...
export const metadata: Metadata = generatePageMetadata({
  title: "4K vs 8K for Home Cinema in India — Is 8K Worth It for Your Private Theatre? | VARELLI",
  description: "Comprehensive guide to 4k vs 8k home cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/4k-vs-8k-home-cinema-india",
  keywords: ["4k vs 8k home cinema india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "4K vs 8K for Home Cinema in India — Is 8K Worth It for Your Private Theatre?",
  description: "Comprehensive guide to 4k vs 8k home cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/4k-vs-8k-home-cinema-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for 4k vs 8k home cinema india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "4K vs 8K for Home Cinema in India — Is 8K Worth It...", href: "/journal/4k-vs-8k-home-cinema-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              4K vs 8K for Home Cinema in India — Is 8K Worth It for Your Private Theatre?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to 4k vs 8k home cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"4K vs 8K for Home Cinema in India — Is 8K Worth It for Your Private Theatre? — Frequently Asked Questions"} />
