...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre for Apartments in Bangalore — Acoustic Solutions",
  description: "Comprehensive guide to Home Theatre for Apartments in Bangalore — Acoustic Solutions. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-apartment-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre for Apartments in Bangalore — Acoustic Solutions",
        "description": "Comprehensive guide to Home Theatre for Apartments in Bangalore — Acoustic Solutions.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
