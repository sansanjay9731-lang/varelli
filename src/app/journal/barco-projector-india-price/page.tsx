...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/barco-projector-india-price",
title: "Barco Home Projector in India — Price Guide for 4K Laser Cinema Room Projectors",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/barco-projector-india-price" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Barco Home Projector in India — Price Guide for 4K Laser Cinema Room Projectors</h1>
          ...
          <div className="content">
            ...
            <p>Barco Residential lineup, India pricing, vs Christie & other laser projectors</p>
