...
export const metadata: Metadata = generatePageMetadata({
  title: "Where to See Luxury Smart Home Products in Bangalore — VARELLI Audition Experience | VARELLI",
  description: "Comprehensive guide to home automation showroom bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-showroom-bangalore",
  keywords: ["home automation showroom bangalore", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Where to See Luxury Smart Home Products in Bangalore — VARELLI Audition Experience",
  description: "Comprehensive guide to home automation showroom bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-showroom-bangalore`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation showroom bangalore?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Where to See Luxury Smart Home Products in Bangalo...", href: "/journal/home-automation-showroom-bangalore" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Where to See Luxury Smart Home Products in Bangalore — VARELLI Audition Experience
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation showroom bangalore for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Where to See Luxury Smart Home Products in Bangalore — VARELLI Audition Experience — Frequently Asked Questions"} />
