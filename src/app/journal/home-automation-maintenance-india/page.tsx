...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Maintenance & Annual Service in India — What to Expect After Installation | VARELLI",
  description: "Comprehensive guide to home automation maintenance india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-maintenance-india",
  keywords: ["home automation maintenance india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Maintenance & Annual Service in India — What to Expect After Installation",
  description: "Comprehensive guide to home automation maintenance india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-maintenance-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation maintenance india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Maintenance & Annual Service in India —...", href: "/journal/home-automation-maintenance-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Maintenance & Annual Service in India — What to Expect After Installation
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation maintenance india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Maintenance & Annual Service in India — What to Expect After Installation — Frequently Asked Questions"} />
