...
export const metadata: Metadata = generatePageMetadata({
  title: "Alexa & Google Home with KNX — Voice Control Integration for Indian Smart Homes | VARELLI",
  description: "Comprehensive guide to alexa google knx integration india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/alexa-google-knx-integration-india",
  keywords: ["alexa google knx integration india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Alexa & Google Home with KNX — Voice Control Integration for Indian Smart Homes",
  description: "Comprehensive guide to alexa google knx integration india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/alexa-google-knx-integration-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for alexa google knx integration india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Alexa & Google Home with KNX — Voice Control Integ...", href: "/journal/alexa-google-knx-integration-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Alexa & Google Home with KNX — Voice Control Integration for Indian Smart Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to alexa google knx integration india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Alexa & Google Home with KNX — Voice Control Integration for Indian Smart Homes — Frequently Asked Questions"} />
