...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Yelahanka, Bangalore — North Bangalore Cinema Guide",
  description: "Comprehensive guide to Home Theatre in Yelahanka, Bangalore — North Bangalore Cinema Guide. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-yelahanka-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre in Yelahanka, Bangalore — North Bangalore Cinema Guide",
        "description": "Comprehensive guide to Home Theatre in Yelahanka, Bangalore — North Bangalore Cinema Guide.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
