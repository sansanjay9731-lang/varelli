...
export const metadata: Metadata = generatePageMetadata({
  title: "Sonus Faber Home Theatre in Bangalore",
  description: "Comprehensive guide to Sonus Faber Home Theatre in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/sonus-faber-home-theatre-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Sonus Faber Home Theatre in Bangalore",
        "description": "Comprehensive guide to Sonus Faber Home Theatre in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
