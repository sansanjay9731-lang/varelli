...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Cinema Room Dimensions Guide — Ideal Size, Aspect Ratio & Layout for India | VARELLI",
  description: "Comprehensive guide to home cinema room dimensions guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-cinema-room-dimensions-guide",
  keywords: ["home cinema room dimensions guide", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Home Cinema Room Dimensions Guide — Ideal Size, Aspect Ratio & Layout for India",
  description: "Comprehensive guide to home cinema room dimensions guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-cinema-room-dimensions-guide`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home cinema room dimensions guide?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Home Cinema Room Dimensions Guide — Ideal Size, As...", href: "/journal/home-cinema-room-dimensions-guide" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Cinema Room Dimensions Guide — Ideal Size, Aspect Ratio & Layout for India
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home cinema room dimensions guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Home Cinema Room Dimensions Guide — Ideal Size, Aspect Ratio & Layout for India — Frequently Asked Questions"} />
