...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Whitefield, Bangalore — Dolby Atmos for IT Villas",
  description: "Comprehensive guide to Home Theatre in Whitefield, Bangalore — Dolby Atmos for IT Villas. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-whitefield-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre in Whitefield, Bangalore — Dolby Atmos for IT Villas",
        "description": "Comprehensive guide to Home Theatre in Whitefield, Bangalore — Dolby Atmos for IT Villas.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            For more localized options, explore our <Link href="/home-theatre/bangalore/whitefield" className="text-blue-600 underline">Home Theatre in Bangalore Whitefield</Link> guide, or view our broader <Link href="/home-theatre/bangalore" className="text-blue-600 underline">Bangalore home theatre services</Link>.
          </p>
