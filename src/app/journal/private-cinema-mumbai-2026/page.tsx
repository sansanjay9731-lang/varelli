...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Mumbai 2026 — Dolby Atmos Home Theatre for Penthouses & Sea-Facing Homes | VARELLI",
  description: "Comprehensive guide to private cinema mumbai 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/private-cinema-mumbai-2026",
  keywords: ["private cinema mumbai 2026", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Private Cinema in Mumbai 2026 — Dolby Atmos Home Theatre for Penthouses & Sea-Facing Homes",
  description: "Comprehensive guide to private cinema mumbai 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/private-cinema-mumbai-2026`,
};

const faqs = [
  {
    question: "What does VARELLI offer for private cinema mumbai 2026?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Private Cinema in Mumbai 2026 — Dolby Atmos Home T...", href: "/journal/private-cinema-mumbai-2026" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Private Cinema in Mumbai 2026 — Dolby Atmos Home Theatre for Penthouses & Sea-Facing Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to private cinema mumbai 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Private Cinema in Mumbai 2026 — Dolby Atmos Home Theatre for Penthouses & Sea-Facing Homes — Frequently Asked Questions"} />
