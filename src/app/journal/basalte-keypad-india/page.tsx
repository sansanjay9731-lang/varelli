...
export const metadata: Metadata = generatePageMetadata({
  title: "Basalte Keypads in India — The Belgian Luxury KNX Touch Panel Guide 2026 | VARELLI",
  description: "Comprehensive guide to basalte keypad india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/basalte-keypad-india",
  keywords: ["basalte keypad india", "smart home India", "luxury home automation India", "KNX India"],
});
...
const articleSchema = {
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/basalte-keypad-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for basalte keypad india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Basalte Keypads in India — The Belgian Luxury KNX ...", href: "/journal/basalte-keypad-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to basalte keypad india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Basalte Keypads in India — The Belgian Luxury KNX Touch Panel Guide 2026 — Frequently Asked Questions"} />
