...
export const metadata: Metadata = generatePageMetadata({
  title: "EV Charging Integration with Smart Home in India — KNX Load Management for Electric Cars | VARELLI",
  description: "Comprehensive guide to ev charging smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/ev-charging-smart-home-india",
  keywords: ["ev charging smart home india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "EV Charging Integration with Smart Home in India — KNX Load Management for Electric Cars",
  description: "Comprehensive guide to ev charging smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/ev-charging-smart-home-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for ev charging smart home india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "EV Charging Integration with Smart Home in India —...", href: "/journal/ev-charging-smart-home-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              EV Charging Integration with Smart Home in India — KNX Load Management for Electric Cars
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to ev charging smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"EV Charging Integration with Smart Home in India — KNX Load Management for Electric Cars — Frequently Asked Questions"} />
