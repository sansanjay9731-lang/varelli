...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Automation Timeline in India — How Long Does Installation Take? | VARELLI",
  description: "Comprehensive guide to home automation timeline india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-timeline-india",
  keywords: ["home automation timeline india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Automation Timeline in India — How Long Does Installation Take?",
  description: "Comprehensive guide to home automation timeline india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-timeline-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation timeline india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Automation Timeline in India — How Long...", href: "/journal/home-automation-timeline-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Automation Timeline in India — How Long Does Installation Take?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation timeline india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Automation Timeline in India — How Long Does Installation Take? — Frequently Asked Questions"} />
