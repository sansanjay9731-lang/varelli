...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Installation Process in Bangalore",
  description: "Comprehensive guide to Home Theatre Installation Process in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-installation-process-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Installation Process in Bangalore",
        "description": "Comprehensive guide to Home Theatre Installation Process in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
