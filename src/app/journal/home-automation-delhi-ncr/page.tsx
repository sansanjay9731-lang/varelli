...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Automation in Delhi NCR — KNX Systems for Gurgaon Villas & Lutyens Residences | VARELLI",
  description: "Comprehensive guide to home automation delhi ncr for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-delhi-ncr",
  keywords: ["home automation delhi ncr", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Automation in Delhi NCR — KNX Systems for Gurgaon Villas & Lutyens Residences",
  description: "Comprehensive guide to home automation delhi ncr for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-delhi-ncr`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation delhi ncr?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Automation in Delhi NCR — KNX Systems f...", href: "/journal/home-automation-delhi-ncr" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Automation in Delhi NCR — KNX Systems for Gurgaon Villas & Lutyens Residences
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation delhi ncr for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Automation in Delhi NCR — KNX Systems for Gurgaon Villas & Lutyens Residences — Frequently Asked Questions"} />
