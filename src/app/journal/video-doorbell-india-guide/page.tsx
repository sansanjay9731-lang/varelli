...
export const metadata: Metadata = generatePageMetadata({
  title: "Video Doorbell Systems in India 2026 — DoorBird vs Ring vs Hikvision for Luxury Homes | VARELLI",
  description: "Comprehensive guide to video doorbell india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/video-doorbell-india-guide",
  keywords: ["video doorbell india guide", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Video Doorbell Systems in India 2026 — DoorBird vs Ring vs Hikvision for Luxury Homes",
  description: "Comprehensive guide to video doorbell india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/video-doorbell-india-guide`,
};

const faqs = [
  {
    question: "What does VARELLI offer for video doorbell india guide?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Video Doorbell Systems in India 2026 — DoorBird vs...", href: "/journal/video-doorbell-india-guide" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Video Doorbell Systems in India 2026 — DoorBird vs Ring vs Hikvision for Luxury Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to video doorbell india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Video Doorbell Systems in India 2026 — DoorBird vs Ring vs Hikvision for Luxury Homes — Frequently Asked Questions"} />
