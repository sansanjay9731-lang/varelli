...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Technology for Interior Designers India — Working with KNX Integrators | VARELLI",
  description: "Comprehensive guide to smart home for interior designers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/smart-home-for-interior-designers-india",
  keywords: ["smart home for interior designers india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Smart Home Technology for Interior Designers India — Working with KNX Integrators",
  description: "Comprehensive guide to smart home for interior designers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/smart-home-for-interior-designers-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for smart home for interior designers india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Technology for Interior Designers India...", href: "/journal/smart-home-for-interior-designers-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Technology for Interior Designers India — Working with KNX Integrators
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to smart home for interior designers india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Technology for Interior Designers India — Working with KNX Integrators — Frequently Asked Questions"} />
