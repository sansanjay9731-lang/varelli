...
export const metadata: Metadata = generatePageMetadata({
  title: "Wired vs Wireless Smart Home in India — Why Architecture-Led KNX Beats WiFi Every Time | VARELLI",
  description: "Comprehensive guide to wired vs wireless smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/wired-vs-wireless-smart-home-india",
  keywords: ["wired vs wireless smart home india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Wired vs Wireless Smart Home in India — Why Architecture-Led KNX Beats WiFi Every Time",
  description: "Comprehensive guide to wired vs wireless smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/wired-vs-wireless-smart-home-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for wired vs wireless smart home india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Wired vs Wireless Smart Home in India — Why Archit...", href: "/journal/wired-vs-wireless-smart-home-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Wired vs Wireless Smart Home in India — Why Architecture-Led KNX Beats WiFi Every Time
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to wired vs wireless smart home india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Wired vs Wireless Smart Home in India — Why Architecture-Led KNX Beats WiFi Every Time — Frequently Asked Questions"} />
