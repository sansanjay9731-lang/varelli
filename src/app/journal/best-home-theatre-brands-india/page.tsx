...
export const metadata: Metadata = generatePageMetadata({
  title: "Best Home Theatre Brands in India 2026 — From Dolby Atmos to 4K Laser Projectors | VARELLI",
  description: "Comprehensive guide to best home theatre brands india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/best-home-theatre-brands-india",
  keywords: ["best home theatre brands india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Best Home Theatre Brands in India 2026 — From Dolby Atmos to 4K Laser Projectors",
  description: "Comprehensive guide to best home theatre brands india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/best-home-theatre-brands-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for best home theatre brands india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Best Home Theatre Brands in India 2026 — From Dolb...", href: "/journal/best-home-theatre-brands-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Best Home Theatre Brands in India 2026 — From Dolby Atmos to 4K Laser Projectors
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to best home theatre brands india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Best Home Theatre Brands in India 2026 — From Dolby Atmos to 4K Laser Projectors — Frequently Asked Questions"} />
