...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/private-cinema-cost-bangalore-2026",
title: "Private Cinema Cost in Bangalore 2026 — Transparent Pricing for Luxury Home Theatres",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/private-cinema-cost-bangalore-2026" }
  ]
