...
export const metadata: Metadata = generatePageMetadata({
  title: "KEF Home Theatre in Bangalore — British Hi-Fi Guide",
  description: "Comprehensive guide to KEF Home Theatre in Bangalore — British Hi-Fi Guide. Discover the best setups, acoustics, and technologies.",
  path: "/journal/kef-home-theatre-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "KEF Home Theatre in Bangalore — British Hi-Fi Guide",
        "description": "Comprehensive guide to KEF Home Theatre in Bangalore — British Hi-Fi Guide.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
