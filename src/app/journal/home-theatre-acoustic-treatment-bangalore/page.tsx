...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Acoustic Treatment in Bangalore",
  description: "Comprehensive guide to Home Theatre Acoustic Treatment in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-acoustic-treatment-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Acoustic Treatment in Bangalore",
        "description": "Comprehensive guide to Home Theatre Acoustic Treatment in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
