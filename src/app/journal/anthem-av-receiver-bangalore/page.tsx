...
export const metadata: Metadata = generatePageMetadata({
  title: "Anthem AV Receiver in Bangalore",
  description: "Comprehensive guide to Anthem AV Receiver in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/anthem-av-receiver-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Anthem AV Receiver in Bangalore",
        "description": "Comprehensive guide to Anthem AV Receiver in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
