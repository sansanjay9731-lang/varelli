...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Seating in Bangalore — Tiered Platform Guide",
  description: "Comprehensive guide to Home Theatre Seating in Bangalore — Tiered Platform Guide. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-seating-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Seating in Bangalore — Tiered Platform Guide",
        "description": "Comprehensive guide to Home Theatre Seating in Bangalore — Tiered Platform Guide.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
