...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Budget in Bangalore — ₹8L to ₹85L Guide",
  description: "Comprehensive guide to Home Theatre Budget in Bangalore — ₹8L to ₹85L Guide. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-budget-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Budget in Bangalore — ₹8L to ₹85L Guide",
        "description": "Comprehensive guide to Home Theatre Budget in Bangalore — ₹8L to ₹85L Guide.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
