...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Automation Guide for Interior Designers in Bangalore",
  ...
  path: "/journal/home-automation-interior-designer-bangalore"
})
...
export default function JournalArticle() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Automation Guide for Interior Designers in Bangalore",
        "author": {
          "@type": "Organization",
          "name": "Varelli"
        },
    ...
    <article className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="mb-10 text-center">
        <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-4">
          Home Automation Guide for Interior Designers in Bangalore
        </h1>
      ...
      <div className="prose prose-lg mx-auto max-w-none text-[#C2C2C8]">
        ...
        <div className="mt-8 mb-12">
          <p>
            ...
            <Link href="/home-automation/bangalore/interior-designer-bangalore" className="text-[#C5A880] hover:text-[#d8ba91] underline">
              Bangalore
            </Link>.
          </p>
        </div>
