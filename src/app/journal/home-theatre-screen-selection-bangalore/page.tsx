...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Screen Selection in Bangalore",
  description: "Comprehensive guide to Home Theatre Screen Selection in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-screen-selection-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre Screen Selection in Bangalore",
        "description": "Comprehensive guide to Home Theatre Screen Selection in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
