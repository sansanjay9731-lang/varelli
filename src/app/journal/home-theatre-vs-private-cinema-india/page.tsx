...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre vs Private Cinema Room — What's the Difference and Which Do You Need? | VARELLI",
  description: "Comprehensive guide to home theatre vs private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-theatre-vs-private-cinema-india",
  keywords: ["home theatre vs private cinema india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Home Theatre vs Private Cinema Room — What's the Difference and Which Do You Need?",
  description: "Comprehensive guide to home theatre vs private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-theatre-vs-private-cinema-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home theatre vs private cinema india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Home Theatre vs Private Cinema Room — What's the D...", href: "/journal/home-theatre-vs-private-cinema-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Theatre vs Private Cinema Room — What's the Difference and Which Do You Need?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home theatre vs private cinema india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Home Theatre vs Private Cinema Room — What's the Difference and Which Do You Need? — Frequently Asked Questions"} />
