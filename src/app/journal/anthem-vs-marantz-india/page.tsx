...
export const metadata: Metadata = generatePageMetadata({
  title: "Anthem vs Marantz AV Receiver for Home Theatre India — Canadian vs Japanese Engineering | VARELLI",
  description: "Comprehensive guide to anthem vs marantz india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/anthem-vs-marantz-india",
  keywords: ["anthem vs marantz india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Anthem vs Marantz AV Receiver for Home Theatre India — Canadian vs Japanese Engineering",
  description: "Comprehensive guide to anthem vs marantz india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/anthem-vs-marantz-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for anthem vs marantz india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Anthem vs Marantz AV Receiver for Home Theatre Ind...", href: "/journal/anthem-vs-marantz-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Anthem vs Marantz AV Receiver for Home Theatre India — Canadian vs Japanese Engineering
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to anthem vs marantz india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Anthem vs Marantz AV Receiver for Home Theatre India — Canadian vs Japanese Engineering — Frequently Asked Questions"} />
