...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Automation in Mumbai — The Architecture-Led 2026 Guide | VARELLI",
  description: "Comprehensive guide to smart home automation mumbai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/smart-home-automation-mumbai",
  keywords: ["smart home automation mumbai", "smart home India", "luxury home automation India", "KNX India"],
});
...
const articleSchema = {
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/smart-home-automation-mumbai`,
};

const faqs = [
  {
    question: "What does VARELLI offer for smart home automation mumbai?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Smart Home Automation in Mumbai — The Architecture...", href: "/journal/smart-home-automation-mumbai" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to smart home automation mumbai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Smart Home Automation in Mumbai — The Architecture-Led 2026 Guide — Frequently Asked Questions"} />
