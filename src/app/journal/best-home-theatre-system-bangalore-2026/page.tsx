...
export const metadata: Metadata = generatePageMetadata({
  title: "Best Home Theatre System for Bangalore Homes 2026",
  description: "Comprehensive guide to Best Home Theatre System for Bangalore Homes 2026. Discover the best setups, acoustics, and technologies.",
  path: "/journal/best-home-theatre-system-bangalore-2026"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Best Home Theatre System for Bangalore Homes 2026",
        "description": "Comprehensive guide to Best Home Theatre System for Bangalore Homes 2026.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
