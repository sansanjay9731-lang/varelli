...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre vs Smart TV Room in Bangalore",
  description: "Comprehensive guide to Home Theatre vs Smart TV Room in Bangalore. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-vs-tv-room-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre vs Smart TV Room in Bangalore",
        "description": "Comprehensive guide to Home Theatre vs Smart TV Room in Bangalore.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
