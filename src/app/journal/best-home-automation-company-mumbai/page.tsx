...
export const metadata: Metadata = generatePageMetadata({
  title: "Best Home Automation Companies in Mumbai 2026 — KNX Integrators for Bandra, Worli & Malabar Hill | VARELLI",
  description: "Comprehensive guide to best home automation company mumbai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/best-home-automation-company-mumbai",
  keywords: ["best home automation company mumbai", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Best Home Automation Companies in Mumbai 2026 — KNX Integrators for Bandra, Worli & Malabar Hill",
  description: "Comprehensive guide to best home automation company mumbai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/best-home-automation-company-mumbai`,
};

const faqs = [
  {
    question: "What does VARELLI offer for best home automation company mumbai?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Best Home Automation Companies in Mumbai 2026 — KN...", href: "/journal/best-home-automation-company-mumbai" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Best Home Automation Companies in Mumbai 2026 — KNX Integrators for Bandra, Worli & Malabar Hill
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to best home automation company mumbai for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Best Home Automation Companies in Mumbai 2026 — KNX Integrators for Bandra, Worli & Malabar Hill — Frequently Asked Questions"} />
