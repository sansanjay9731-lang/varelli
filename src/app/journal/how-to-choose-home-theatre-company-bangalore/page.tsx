...
export const metadata: Metadata = generatePageMetadata({
  title: "How to Choose a Home Theatre Company in Bangalore — 7 Key Questions | VARELLI Journal",
  description: "Read our comprehensive guide: How to Choose a Home Theatre Company in Bangalore — 7 Key Questions. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/how-to-choose-home-theatre-company-bangalore",
  keywords: ["how to choose a home theatre company in bangalore — 7 key questions", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "How to Choose a Home Theatre Company in Bangalore — 7 Key Questions",
    "description": "Read our comprehensive guide: How to Choose a Home Theatre Company in Bangalore — 7 Key Questions. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/how-to-choose-home-theatre-company-bangalore' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            How to Choose a Home Theatre Company in Bangalore — 7 Key Questions
          </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none text-[#C2C2C8] mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>How to Choose a Home Theatre Company in Bangalore — 7 Key Questions</strong>, aims to clarify this landscape.
          </p>
          <p>
