...
export const metadata: Metadata = generatePageMetadata({
  title: "KNX vs Home Assistant for Luxury Home Automation in India — Professional vs DIY | VARELLI",
  description: "Comprehensive guide to knx vs home assistant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/knx-vs-home-assistant-india",
  keywords: ["knx vs home assistant india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "KNX vs Home Assistant for Luxury Home Automation in India — Professional vs DIY",
  description: "Comprehensive guide to knx vs home assistant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/knx-vs-home-assistant-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for knx vs home assistant india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "KNX vs Home Assistant for Luxury Home Automation i...", href: "/journal/knx-vs-home-assistant-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              KNX vs Home Assistant for Luxury Home Automation in India — Professional vs DIY
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to knx vs home assistant india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"KNX vs Home Assistant for Luxury Home Automation in India — Professional vs DIY — Frequently Asked Questions"} />
