...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Delhi NCR 2026 — Home Theatre Design for Gurgaon Villas & Lutyens Estates | VARELLI",
  description: "Comprehensive guide to private cinema delhi ncr 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/private-cinema-delhi-ncr-2026",
  keywords: ["private cinema delhi ncr 2026", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Private Cinema in Delhi NCR 2026 — Home Theatre Design for Gurgaon Villas & Lutyens Estates",
  description: "Comprehensive guide to private cinema delhi ncr 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/private-cinema-delhi-ncr-2026`,
};

const faqs = [
  {
    question: "What does VARELLI offer for private cinema delhi ncr 2026?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Private Cinema in Delhi NCR 2026 — Home Theatre De...", href: "/journal/private-cinema-delhi-ncr-2026" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Private Cinema in Delhi NCR 2026 — Home Theatre Design for Gurgaon Villas & Lutyens Estates
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to private cinema delhi ncr 2026 for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Private Cinema in Delhi NCR 2026 — Home Theatre Design for Gurgaon Villas & Lutyens Estates — Frequently Asked Questions"} />
