...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/private-cinema-cost-india-2026",
title: "Private Cinema Room Cost in India 2026 — From Dolby Atmos to 8K Reference Cinema",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/private-cinema-cost-india-2026" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Private Cinema Room Cost in India 2026 — From Dolby Atmos to 8K Reference Cinema</h1>
          ...
          <div className="content">
            ...
            <p>room construction, acoustic treatment, AV equipment, seating cost breakdown</p>
