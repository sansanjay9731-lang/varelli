...
export const metadata: Metadata = generatePageMetadata({
  title: "Multi-Room Audio Systems in India — Architectural Sound for Every Room in Your Home | VARELLI",
  description: "Comprehensive guide to multiroom audio india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/multiroom-audio-india",
  keywords: ["multiroom audio india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Multi-Room Audio Systems in India — Architectural Sound for Every Room in Your Home",
  description: "Comprehensive guide to multiroom audio india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/multiroom-audio-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for multiroom audio india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Multi-Room Audio Systems in India — Architectural ...", href: "/journal/multiroom-audio-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Multi-Room Audio Systems in India — Architectural Sound for Every Room in Your Home
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to multiroom audio india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Multi-Room Audio Systems in India — Architectural Sound for Every Room in Your Home — Frequently Asked Questions"} />
