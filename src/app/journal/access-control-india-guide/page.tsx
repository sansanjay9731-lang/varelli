...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Access Control Systems in India 2026 — Biometric, RFID & Fingerprint Door Locks | VARELLI",
  description: "Comprehensive guide to access control india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/access-control-india-guide",
  keywords: ["access control india guide", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Home Access Control Systems in India 2026 — Biometric, RFID & Fingerprint Door Locks",
  description: "Comprehensive guide to access control india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/access-control-india-guide`,
};

const faqs = [
  {
    question: "What does VARELLI offer for access control india guide?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Home Access Control Systems in India 2026 — Biomet...", href: "/journal/access-control-india-guide" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Access Control Systems in India 2026 — Biometric, RFID & Fingerprint Door Locks
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to access control india guide for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Home Access Control Systems in India 2026 — Biometric, RFID & Fingerprint Door Locks — Frequently Asked Questions"} />
