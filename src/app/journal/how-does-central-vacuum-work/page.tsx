...
export const metadata: Metadata = generatePageMetadata({
  title: "How Does a Central Vacuum System Work? Complete Guide for Indian Homes | VARELLI",
  description: "Comprehensive guide to how does central vacuum work for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/how-does-central-vacuum-work",
  keywords: ["how does central vacuum work", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "How Does a Central Vacuum System Work? Complete Guide for Indian Homes",
  description: "Comprehensive guide to how does central vacuum work for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/how-does-central-vacuum-work`,
};

const faqs = [
  {
    question: "What does VARELLI offer for how does central vacuum work?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "How Does a Central Vacuum System Work? Complete Gu...", href: "/journal/how-does-central-vacuum-work" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              How Does a Central Vacuum System Work? Complete Guide for Indian Homes
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to how does central vacuum work for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"How Does a Central Vacuum System Work? Complete Guide for Indian Homes — Frequently Asked Questions"} />
