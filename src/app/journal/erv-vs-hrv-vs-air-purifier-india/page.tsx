...
export const metadata: Metadata = generatePageMetadata({
  title: "ERV vs HRV vs Air Purifier for Indian Homes — Which Fresh Air System is Right for You? | VARELLI",
  description: "Comprehensive guide to erv vs hrv vs air purifier india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/erv-vs-hrv-vs-air-purifier-india",
  keywords: ["erv vs hrv vs air purifier india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "ERV vs HRV vs Air Purifier for Indian Homes — Which Fresh Air System is Right for You?",
  description: "Comprehensive guide to erv vs hrv vs air purifier india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/erv-vs-hrv-vs-air-purifier-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for erv vs hrv vs air purifier india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "ERV vs HRV vs Air Purifier for Indian Homes — Whic...", href: "/journal/erv-vs-hrv-vs-air-purifier-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              ERV vs HRV vs Air Purifier for Indian Homes — Which Fresh Air System is Right for You?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to erv vs hrv vs air purifier india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"ERV vs HRV vs Air Purifier for Indian Homes — Which Fresh Air System is Right for You? — Frequently Asked Questions"} />
