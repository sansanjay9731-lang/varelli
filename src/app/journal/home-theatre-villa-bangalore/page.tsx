...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre for Villas in Bangalore — Dedicated Room vs Living Room",
  description: "Comprehensive guide to Home Theatre for Villas in Bangalore — Dedicated Room vs Living Room. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-villa-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre for Villas in Bangalore — Dedicated Room vs Living Room",
        "description": "Comprehensive guide to Home Theatre for Villas in Bangalore — Dedicated Room vs Living Room.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
