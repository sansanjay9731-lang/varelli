...
export const metadata: Metadata = generatePageMetadata({
  title: "Smart Home Companies in Bangalore 2026 — How to Choose | VARELLI Journal",
  description: "Read our comprehensive guide: Smart Home Companies in Bangalore 2026 — How to Choose. Expert insights from VARELLI on luxury home technology.",
  path: "/journal/smart-home-companies-bangalore-2026",
  keywords: ["smart home companies in bangalore 2026 — how to choose", "varelli journal", "bangalore"],
})
...
export default function JournalArticlePage() {
  ...
  const articleSchema = {
    ...
    "@type": "Article",
    "headline": "Smart Home Companies in Bangalore 2026 — How to Choose",
    "description": "Read our comprehensive guide: Smart Home Companies in Bangalore 2026 — How to Choose. Expert insights from VARELLI on luxury home technology.",
    "author": {
      "@type": "Organization",
      "name": "VARELLI"
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: 'Article', href: '/journal/smart-home-companies-bangalore-2026' }
        ]}
      />
      ...
      <article className="py-16 md:py-24 px-6 max-w-4xl mx-auto w-full">
        <header className="mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Smart Home Companies in Bangalore 2026 — How to Choose
          </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none text-[#C2C2C8] mb-16">
          ...
          <p>
            ...
            between basic AV installations and engineered reference-grade experiences. This guide, <strong>Smart Home Companies in Bangalore 2026 — How to Choose</strong>, aims to clarify this landscape.
          </p>
          <p>
      ...
      <ServiceCTA serviceName="Smart Home" />
    </main>
  )
}
