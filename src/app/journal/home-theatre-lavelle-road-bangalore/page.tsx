...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Lavelle Road, Bangalore — Premium Central Bangalore AV",
  description: "Comprehensive guide to Home Theatre in Lavelle Road, Bangalore — Premium Central Bangalore AV. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-lavelle-road-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre in Lavelle Road, Bangalore — Premium Central Bangalore AV",
        "description": "Comprehensive guide to Home Theatre in Lavelle Road, Bangalore — Premium Central Bangalore AV.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            For more localized options, explore our <Link href="/home-theatre/bangalore/lavelle-road" className="text-blue-600 underline">Home Theatre in Bangalore Lavelle Road</Link> guide, or view our broader <Link href="/home-theatre/bangalore" className="text-blue-600 underline">Bangalore home theatre services</Link>.
          </p>
