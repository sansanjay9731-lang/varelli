...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre in Malleshwaram, Bangalore — Heritage Home Cinema",
  description: "Comprehensive guide to Home Theatre in Malleshwaram, Bangalore — Heritage Home Cinema. Discover the best setups, acoustics, and technologies.",
  path: "/journal/home-theatre-malleshwaram-bangalore"
})
...
export default function Page() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Article",
        "headline": "Home Theatre in Malleshwaram, Bangalore — Heritage Home Cinema",
        "description": "Comprehensive guide to Home Theatre in Malleshwaram, Bangalore — Heritage Home Cinema.",
        "author": {
          "@type": "Organization",
          "name": "VARELLI"
        }
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <article className="prose prose-lg max-w-4xl mx-auto">
          ...
          <p>
            ...
            For more localized options, explore our <Link href="/home-theatre/bangalore/malleshwaram" className="text-blue-600 underline">Home Theatre in Bangalore Malleshwaram</Link> guide, or view our broader <Link href="/home-theatre/bangalore" className="text-blue-600 underline">Bangalore home theatre services</Link>.
          </p>
