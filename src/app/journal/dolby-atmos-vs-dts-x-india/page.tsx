...
export const metadata: Metadata = generatePageMetadata({
  title: "Dolby Atmos vs DTS:X — Which Surround Sound Format is Best for Home Theatre India? | VARELLI",
  description: "Comprehensive guide to dolby atmos vs dts x india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/dolby-atmos-vs-dts-x-india",
  keywords: ["dolby atmos vs dts x india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Dolby Atmos vs DTS:X — Which Surround Sound Format is Best for Home Theatre India?",
  description: "Comprehensive guide to dolby atmos vs dts x india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/dolby-atmos-vs-dts-x-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for dolby atmos vs dts x india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Dolby Atmos vs DTS:X — Which Surround Sound Format...", href: "/journal/dolby-atmos-vs-dts-x-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Dolby Atmos vs DTS:X — Which Surround Sound Format is Best for Home Theatre India?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to dolby atmos vs dts x india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Dolby Atmos vs DTS:X — Which Surround Sound Format is Best for Home Theatre India? — Frequently Asked Questions"} />
