...
export const metadata: Metadata = generatePageMetadata({
  title: "Sonus Faber vs KEF Speakers for Home Cinema India — Italian Soul vs British Precision | VARELLI",
  description: "Comprehensive guide to sonus faber vs kef india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/sonus-faber-vs-kef-india",
  keywords: ["sonus faber vs kef india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Sonus Faber vs KEF Speakers for Home Cinema India — Italian Soul vs British Precision",
  description: "Comprehensive guide to sonus faber vs kef india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/sonus-faber-vs-kef-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for sonus faber vs kef india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Sonus Faber vs KEF Speakers for Home Cinema India ...", href: "/journal/sonus-faber-vs-kef-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Sonus Faber vs KEF Speakers for Home Cinema India — Italian Soul vs British Precision
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to sonus faber vs kef india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Sonus Faber vs KEF Speakers for Home Cinema India — Italian Soul vs British Precision — Frequently Asked Questions"} />
