...
export const metadata: Metadata = generatePageMetadata({
  title: "How Smart Home Automation Saves Energy in Indian Homes — KNX vs Manual Consumption | VARELLI",
  description: "Comprehensive guide to smart home energy saving india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/smart-home-energy-saving-india",
  keywords: ["smart home energy saving india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "How Smart Home Automation Saves Energy in Indian Homes — KNX vs Manual Consumption",
  description: "Comprehensive guide to smart home energy saving india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/smart-home-energy-saving-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for smart home energy saving india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "How Smart Home Automation Saves Energy in Indian H...", href: "/journal/smart-home-energy-saving-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              How Smart Home Automation Saves Energy in Indian Homes — KNX vs Manual Consumption
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to smart home energy saving india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"How Smart Home Automation Saves Energy in Indian Homes — KNX vs Manual Consumption — Frequently Asked Questions"} />
