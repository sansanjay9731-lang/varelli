...
export const metadata: Metadata = generatePageMetadata({
  title: "4K Laser Projector vs OLED TV for Home Cinema India — Which Should You Choose? | VARELLI",
  description: "Comprehensive guide to 4k projector vs oled tv home cinema for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/4k-projector-vs-oled-tv-home-cinema",
  keywords: ["4k projector vs oled tv home cinema", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "4K Laser Projector vs OLED TV for Home Cinema India — Which Should You Choose?",
  description: "Comprehensive guide to 4k projector vs oled tv home cinema for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/4k-projector-vs-oled-tv-home-cinema`,
};

const faqs = [
  {
    question: "What does VARELLI offer for 4k projector vs oled tv home cinema?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "4K Laser Projector vs OLED TV for Home Cinema Indi...", href: "/journal/4k-projector-vs-oled-tv-home-cinema" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              4K Laser Projector vs OLED TV for Home Cinema India — Which Should You Choose?
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to 4k projector vs oled tv home cinema for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"4K Laser Projector vs OLED TV for Home Cinema India — Which Should You Choose? — Frequently Asked Questions"} />
