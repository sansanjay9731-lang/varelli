...
export const metadata: Metadata = generatePageMetadata({
  path: "/journal/home-networking-cost-india-2026",
title: "Home Networking System Cost in India 2026 — Structured Cabling & Wi-Fi 6E Pricing Guide",
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Pricing Guide", href: "/journal/home-networking-cost-india-2026" }
  ]
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <article className="w-full py-20 px-4">
        <div className="container mx-auto max-w-4xl prose lg:prose-xl">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Home Networking System Cost in India 2026 — Structured Cabling & Wi-Fi 6E Pricing Guide</h1>
          ...
          <div className="content">
            ...
            <p>UniFi / Cisco Meraki pricing, Cat6A cabling cost, whole-home coverage</p>
