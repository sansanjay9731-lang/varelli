...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Automation for Architects in India — How to Specify KNX Systems at First Fix | VARELLI",
  description: "Comprehensive guide to home automation for architects india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-for-architects-india",
  keywords: ["home automation for architects india", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Home Automation for Architects in India — How to Specify KNX Systems at First Fix",
  description: "Comprehensive guide to home automation for architects india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-for-architects-india`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation for architects india?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Home Automation for Architects in India — How to S...", href: "/journal/home-automation-for-architects-india" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Automation for Architects in India — How to Specify KNX Systems at First Fix
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation for architects india for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Home Automation for Architects in India — How to Specify KNX Systems at First Fix — Frequently Asked Questions"} />
