...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation in Pune — KNX Systems for Koregaon Park & Kalyani Nagar Villas | VARELLI",
  description: "Comprehensive guide to home automation pune for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  path: "/journal/home-automation-pune",
  keywords: ["home automation pune", "smart home India", "luxury home automation India", "KNX India"],
});

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Luxury Home Automation in Pune — KNX Systems for Koregaon Park & Kalyani Nagar Villas",
  description: "Comprehensive guide to home automation pune for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.",
  ...
  mainEntityOfPage: `https://varelli.co.in/journal/home-automation-pune`,
};

const faqs = [
  {
    question: "What does VARELLI offer for home automation pune?",
...
export default function Page() {
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Luxury Home Automation in Pune — KNX Systems for K...", href: "/journal/home-automation-pune" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            ...
            <h1 className="font-display text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-[1.08] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Luxury Home Automation in Pune — KNX Systems for Koregaon Park & Kalyani Nagar Villas
            </h1>
            <p className="font-editorial text-xl text-[var(--text-secondary)] leading-relaxed italic mb-8">
              Comprehensive guide to home automation pune for luxury homeowners in India. Expert analysis from VARELLI, India's architecture-first smart home integrator.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={faqs} title={"Luxury Home Automation in Pune — KNX Systems for Koregaon Park & Kalyani Nagar Villas — Frequently Asked Questions"} />
