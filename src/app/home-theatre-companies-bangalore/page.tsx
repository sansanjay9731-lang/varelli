...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Theatre Companies in Bangalore — VARELLI | VARELLI",
  description: "VARELLI is the leading luxury integrator for Home Theatre Companies in Bangalore — VARELLI. Discover premium smart home and private cinema solutions.",
  path: "/home-theatre-companies-bangalore",
  keywords: ["home-theatre-companies-bangalore", "bangalore"],
})
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "VARELLI",
  url: "https://varelli.co.in/home-theatre-companies-bangalore",
      ...
      <section className="relative bg-[var(--surface-1)] border-b border-[var(--border)]">
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb items={[
            ...
            { name: "Home Theatre Companies in Bangalore — VARELLI", href: "/home-theatre-companies-bangalore" },
          ]} />
          <div className="mt-6 max-w-3xl">
            <h1 className="font-display text-[clamp(2.2rem,5vw,4rem)] font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Home Theatre Companies in Bangalore — VARELLI
            </h1>
