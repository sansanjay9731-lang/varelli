...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation System in Kalyan Nagar, Bangalore — Zehnder ERV | VARELLI",
  description: "Swiss Zehnder ComfoAir ERV whole-home fresh air ventilation for luxury residences in Kalyan Nagar, Bangalore. Filters PM2.5, reduces CO2, 95% energy recovery.",
  path: "/fresh-air-ventilation/bangalore/kalyan-nagar",
  keywords: ["fresh air ventilation Kalyan Nagar bangalore", "ERV system Kalyan Nagar", "home ventilation bangalore", "Zehnder ventilation bangalore"],
})

export default function FreshAirKalyanNagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Fresh Air Ventilation Kalyan Nagar",
        "description": "Premium Zehnder fresh air ventilation systems in Kalyan Nagar, Bangalore.",
        "areaServed": "Kalyan Nagar, Bangalore"
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best fresh air system in Kalyan Nagar, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The Zehnder ERV system is the premier choice for luxury homes in Kalyan Nagar, offering superior PM2.5 filtration and energy recovery."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "How to improve indoor air quality in Kalyan Nagar?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "What is the cost of ERV in Kalyan Nagar?",
            "acceptedAnswer": {
              "@type": "Answer",
  ...
  const faqs = [
    { question: "What is the best fresh air system in Kalyan Nagar, Bangalore?", answer: "The Zehnder ERV system is the premier choice for luxury homes in Kalyan Nagar, offering superior PM2.5 filtration and energy recovery." },
    ...
    { question: "How to improve indoor air quality in Kalyan Nagar?", answer: "Installing a whole-home ERV system helps filter out pollutants, reduces CO2 buildup, and maintains fresh air circulation." },
    { question: "What is the cost of ERV in Kalyan Nagar?", answer: "Systems range from ₹2.8L for studios up to ₹18L+ for large villas, depending on requirements." },
    ...
    <main className="min-h-screen">
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Kalyan Nagar", href: "/fresh-air-ventilation/bangalore/kalyan-nagar" }
        ]}
      />
