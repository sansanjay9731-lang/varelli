...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation System in Rr Nagar, Bangalore — Zehnder ERV | VARELLI",
  description: "Swiss Zehnder ComfoAir ERV whole-home fresh air ventilation for luxury residences in Rr Nagar, Bangalore. Filters PM2.5, reduces CO2, 95% energy recovery.",
  path: "/fresh-air-ventilation/bangalore/rr-nagar",
  keywords: ["fresh air ventilation Rr Nagar bangalore", "ERV system Rr Nagar", "home ventilation bangalore", "Zehnder ventilation bangalore"],
})

export default function FreshAirRrNagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Fresh Air Ventilation Rr Nagar",
        "description": "Premium Zehnder fresh air ventilation systems in Rr Nagar, Bangalore.",
        "areaServed": "Rr Nagar, Bangalore"
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best fresh air system in Rr Nagar, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The Zehnder ERV system is the premier choice for luxury homes in Rr Nagar, offering superior PM2.5 filtration and energy recovery."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "How to improve indoor air quality in Rr Nagar?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "What is the cost of ERV in Rr Nagar?",
            "acceptedAnswer": {
              "@type": "Answer",
  ...
  const faqs = [
    { question: "What is the best fresh air system in Rr Nagar, Bangalore?", answer: "The Zehnder ERV system is the premier choice for luxury homes in Rr Nagar, offering superior PM2.5 filtration and energy recovery." },
    ...
    { question: "How to improve indoor air quality in Rr Nagar?", answer: "Installing a whole-home ERV system helps filter out pollutants, reduces CO2 buildup, and maintains fresh air circulation." },
    { question: "What is the cost of ERV in Rr Nagar?", answer: "Systems range from ₹2.8L for studios up to ₹18L+ for large villas, depending on requirements." },
