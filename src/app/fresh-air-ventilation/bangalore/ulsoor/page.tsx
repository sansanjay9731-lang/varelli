...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation System in Ulsoor, Bangalore — Zehnder ERV | VARELLI",
  description: "Swiss Zehnder ComfoAir ERV whole-home fresh air ventilation for luxury residences in Ulsoor, Bangalore. Filters PM2.5, reduces CO2, 95% energy recovery.",
  path: "/fresh-air-ventilation/bangalore/ulsoor",
  keywords: ["fresh air ventilation Ulsoor bangalore", "ERV system Ulsoor", "home ventilation bangalore", "Zehnder ventilation bangalore"],
})

export default function FreshAirUlsoorPage() {
  const schema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "LocalBusiness",
        "name": "VARELLI - Fresh Air Ventilation Ulsoor",
        "description": "Premium Zehnder fresh air ventilation systems in Ulsoor, Bangalore.",
        "areaServed": "Ulsoor, Bangalore"
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is the best fresh air system in Ulsoor, Bangalore?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The Zehnder ERV system is the premier choice for luxury homes in Ulsoor, offering superior PM2.5 filtration and energy recovery."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "How to improve indoor air quality in Ulsoor?",
            "acceptedAnswer": {
              "@type": "Answer",
          ...
          {
            "@type": "Question",
            "name": "What is the cost of ERV in Ulsoor?",
            "acceptedAnswer": {
              "@type": "Answer",
  ...
  const faqs = [
    { question: "What is the best fresh air system in Ulsoor, Bangalore?", answer: "The Zehnder ERV system is the premier choice for luxury homes in Ulsoor, offering superior PM2.5 filtration and energy recovery." },
    ...
    { question: "How to improve indoor air quality in Ulsoor?", answer: "Installing a whole-home ERV system helps filter out pollutants, reduces CO2 buildup, and maintains fresh air circulation." },
    { question: "What is the cost of ERV in Ulsoor?", answer: "Systems range from ₹2.8L for studios up to ₹18L+ for large villas, depending on requirements." },
