...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Sushant Lok, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Sushant Lok. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/sushant-lok"
})

export default function FreshAirVentilationsushantlokPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Sushant Lok",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Sushant Lok", href: "/fresh-air-ventilation/delhi-ncr/sushant-lok" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Sushant Lok, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Sushant Lok, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Sushant Lok Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Sushant Lok and the Delhi NCR region."
          },
          {
