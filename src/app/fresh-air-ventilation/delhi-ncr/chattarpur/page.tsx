...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Chattarpur, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Chattarpur. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/chattarpur"
})

export default function FreshAirVentilationchattarpurPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Chattarpur",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    "areaServed": "Chattarpur, Delhi NCR"
  }
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Chattarpur", href: "/fresh-air-ventilation/delhi-ncr/chattarpur" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Chattarpur, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Chattarpur, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Chattarpur Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Chattarpur and the Delhi NCR region."
          },
          {
