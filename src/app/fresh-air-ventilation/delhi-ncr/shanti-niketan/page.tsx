...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Shanti Niketan, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Shanti Niketan. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/shanti-niketan"
})

export default function FreshAirVentilationshantiniketanPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Shanti Niketan",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Shanti Niketan", href: "/fresh-air-ventilation/delhi-ncr/shanti-niketan" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Shanti Niketan, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Shanti Niketan, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Shanti Niketan Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Shanti Niketan and the Delhi NCR region."
          },
          {
