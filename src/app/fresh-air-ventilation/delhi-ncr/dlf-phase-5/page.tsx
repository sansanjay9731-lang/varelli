...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Dlf Phase 5, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Dlf Phase 5. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/dlf-phase-5"
})

export default function FreshAirVentilationdlfphase5Page() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Dlf Phase 5",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Dlf Phase 5", href: "/fresh-air-ventilation/delhi-ncr/dlf-phase-5" }
        ]} 
      />
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Dlf Phase 5 Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Dlf Phase 5 and the Delhi NCR region."
          },
          {
