...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Noida Sector 44, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Noida Sector 44. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/noida-sector-44"
})

export default function FreshAirVentilationnoidasector44Page() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Noida Sector 44",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Noida Sector 44", href: "/fresh-air-ventilation/delhi-ncr/noida-sector-44" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Noida Sector 44, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Noida Sector 44, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Noida Sector 44 Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Noida Sector 44 and the Delhi NCR region."
          },
          {
