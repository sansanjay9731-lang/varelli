...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Lutyens Delhi, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Lutyens Delhi. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/lutyens-delhi"
})

export default function FreshAirVentilationlutyensdelhiPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Lutyens Delhi",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Lutyens Delhi", href: "/fresh-air-ventilation/delhi-ncr/lutyens-delhi" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Lutyens Delhi, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Lutyens Delhi, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Lutyens Delhi Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Lutyens Delhi and the Delhi NCR region."
          },
          {
