...
export const metadata: Metadata = generatePageMetadata({
  title: "Fresh Air Ventilation in Sundar Nagar, Delhi NCR — Zehnder ERV | VARELLI",
  description: "Combat Delhi's severe AQI with Zehnder ERV fresh air ventilation systems in Sundar Nagar. H13 HEPA filtration for farmhouses and apartments.",
  path: "/fresh-air-ventilation/delhi-ncr/sundar-nagar"
})

export default function FreshAirVentilationsundarnagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Fresh Air Ventilation Installation in Sundar Nagar",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Sundar Nagar", href: "/fresh-air-ventilation/delhi-ncr/sundar-nagar" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Fresh Air Ventilation in Sundar Nagar, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            ...
            ventilation. Essential for sealed AC farmhouses and luxury homes in Sundar Nagar, featuring 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Do you install fresh air ventilation in Sundar Nagar Delhi?",
            answer: "Yes, we install high-end Zehnder ERV systems across Sundar Nagar and the Delhi NCR region."
          },
          {
