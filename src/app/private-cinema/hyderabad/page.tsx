...
const city = getCityBySlug("hyderabad")!;

export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Private Cinema Hyderabad - Dolby Atmos 9.4.6 & Custom Acoustics | VARELLI",
  description: "VARELLI designs luxury private cinema systems for villas, penthouses and private residences in Hyderabad. Architectural integration, European brands & transparent pricing.",
  path: "/private-cinema/hyderabad",
  keywords: [
    "private cinema Hyderabad",
    "smart home Hyderabad",
    "luxury private cinema Hyderabad",
    "private cinema company Hyderabad",
    "KNX certified integrator Hyderabad",
    "villa automation Hyderabad",
    "home theatre Hyderabad",
    "Dolby Atmos Hyderabad",
  ],
});

export default function HyderabadPrivatecinemaPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Hyderabad",
    url: "https://varelli.co.in/private-cinema/hyderabad",
    description: "VARELLI designs " + service.name.toLowerCase() + " systems for luxury residences in Hyderabad."
  });
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Hyderabad", href: "/private-cinema/hyderabad" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            <span className="badge-mono block mb-5">{service.name} · Hyderabad</span>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                Schedule Hyderabad Consultation
              </Link>
              <Link
                href="/studio"
        ...
        <section className="py-16 border-b border-[var(--border)] bg-[#08080A]">
          <div className="container-varelli">
            ...
            <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-8">
              Serving Luxury Residences Across Hyderabad
            </h2>
      ...
      <FAQSection faqs={city.faqs} title="Private Cinema in Hyderabad — Frequently Asked Questions" />
