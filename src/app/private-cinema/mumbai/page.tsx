...
const city = getCityBySlug("mumbai")!;

export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Private Cinema Mumbai - Dolby Atmos 9.4.6 & Custom Acoustics | VARELLI",
  description: "VARELLI designs luxury private cinema systems for villas, penthouses and private residences in Mumbai. Architectural integration, European brands & transparent pricing.",
  path: "/private-cinema/mumbai",
  keywords: [
    "private cinema Mumbai",
    "smart home Mumbai",
    "luxury private cinema Mumbai",
    "private cinema company Mumbai",
    "KNX certified integrator Mumbai",
    "villa automation Mumbai",
    "home theatre Mumbai",
    "Dolby Atmos Mumbai",
  ],
});

export default function MumbaiPrivatecinemaPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Mumbai",
    url: "https://varelli.co.in/private-cinema/mumbai",
    description: "VARELLI designs " + service.name.toLowerCase() + " systems for luxury residences in Mumbai."
  });
  ...
  return (
    <>
      ...
      <section className="relative bg-[var(--surface-1)] border-b border-[var(--border)]">
        <div className="relative container-varelli pt-40 pb-16">
          ...
          <div className="mt-6 max-w-3xl">
            <span className="badge-mono block mb-5">{service.name} · Mumbai</span>
        ...
        <section className="py-16 border-b border-[var(--border)] bg-[#08080A]">
          <div className="container-varelli">
            ...
            <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-8">
              Serving Luxury Residences Across Mumbai
            </h2>
      ...
      <FAQSection faqs={city.faqs} title="Private Cinema in Mumbai — Frequently Asked Questions" />
