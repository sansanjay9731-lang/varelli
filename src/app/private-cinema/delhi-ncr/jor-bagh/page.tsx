...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Jor Bagh, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Jor Bagh, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/jor-bagh"
})

export default function PrivateCinemajorbaghPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Jor Bagh",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Jor Bagh", href: "/private-cinema/delhi-ncr/jor-bagh" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in Jor Bagh, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in Jor Bagh. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Jor Bagh Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Jor Bagh and across Delhi NCR."
          },
          {
