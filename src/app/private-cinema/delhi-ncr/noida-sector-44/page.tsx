...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Noida Sector 44, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Noida Sector 44, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/noida-sector-44"
})

export default function PrivateCinemanoidasector44Page() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Noida Sector 44",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Noida Sector 44", href: "/private-cinema/delhi-ncr/noida-sector-44" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in Noida Sector 44, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in Noida Sector 44. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Noida Sector 44 Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Noida Sector 44 and across Delhi NCR."
          },
          {
