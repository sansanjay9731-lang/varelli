...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Sundar Nagar, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Sundar Nagar, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/sundar-nagar"
})

export default function PrivateCinemasundarnagarPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Sundar Nagar",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Sundar Nagar", href: "/private-cinema/delhi-ncr/sundar-nagar" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in Sundar Nagar, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in Sundar Nagar. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Sundar Nagar Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Sundar Nagar and across Delhi NCR."
          },
          {
