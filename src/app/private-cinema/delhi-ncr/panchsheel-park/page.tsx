...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Panchsheel Park, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Panchsheel Park, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/panchsheel-park"
})

export default function PrivateCinemapanchsheelparkPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Panchsheel Park",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Panchsheel Park", href: "/private-cinema/delhi-ncr/panchsheel-park" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in Panchsheel Park, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in Panchsheel Park. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Panchsheel Park Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Panchsheel Park and across Delhi NCR."
          },
          {
