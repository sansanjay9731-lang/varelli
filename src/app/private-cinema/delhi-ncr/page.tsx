...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Private Cinema Delhi NCR - Dolby Atmos 9.4.6 & Custom Acoustics | VARELLI",
  description: "VARELLI designs luxury private cinema systems for villas, penthouses and private residences in Delhi NCR. Architectural integration, European brands & transparent pricing.",
  path: "/private-cinema/delhi-ncr",
  keywords: [
    "private cinema Delhi NCR",
    "smart home Delhi NCR",
    "luxury private cinema Delhi NCR",
    "private cinema company Delhi NCR",
...
export default function DelhincrPrivatecinemaPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Delhi NCR",
    url: "https://varelli.co.in/private-cinema/delhi-ncr",
  ...
  return (
    <>
      ...
      <FAQSection faqs={city.faqs} title="Private Cinema in Delhi NCR — Frequently Asked Questions" />
