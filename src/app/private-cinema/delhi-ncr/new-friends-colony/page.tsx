...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in New Friends Colony, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in New Friends Colony, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/new-friends-colony"
})

export default function PrivateCinemanewfriendscolonyPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in New Friends Colony",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "New Friends Colony", href: "/private-cinema/delhi-ncr/new-friends-colony" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in New Friends Colony, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in New Friends Colony. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in New Friends Colony Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in New Friends Colony and across Delhi NCR."
          },
          {
