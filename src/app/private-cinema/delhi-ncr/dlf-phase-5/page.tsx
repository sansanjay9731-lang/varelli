...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Dlf Phase 5, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Dlf Phase 5, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/dlf-phase-5"
})

export default function PrivateCinemadlfphase5Page() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Dlf Phase 5",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Dlf Phase 5", href: "/private-cinema/delhi-ncr/dlf-phase-5" }
        ]} 
      />
      
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Private Cinema in Dlf Phase 5, Delhi NCR</h1>
          <p className="text-lg md:text-xl text-[#A0A0A5] max-w-3xl mb-8">
            Experience the pinnacle of cinematic luxury in Dlf Phase 5. We design and build dedicated 
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Dlf Phase 5 Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Dlf Phase 5 and across Delhi NCR."
          },
          {
