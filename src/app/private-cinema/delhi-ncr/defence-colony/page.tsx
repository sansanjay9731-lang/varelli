...
export const metadata: Metadata = generatePageMetadata({
  title: "Private Cinema in Defence Colony, Delhi NCR — Dedicated Cinema Room | VARELLI",
  description: "Bespoke private cinema rooms in Defence Colony, Delhi NCR. Dedicated screening rooms for bungalows and farmhouses featuring Dolby Atmos.",
  path: "/private-cinema/delhi-ncr/defence-colony"
})

export default function PrivateCinemadefencecolonyPage() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Private Cinema Design in Defence Colony",
    "provider": {
      "@type": "Organization",
      "name": "VARELLI"
    },
    ...
    <main>
      ...
      <Breadcrumb 
        items={[
          ...
          { name: "Defence Colony", href: "/private-cinema/delhi-ncr/defence-colony" }
        ]} 
      />
      ...
      <FAQSection 
        faqs={[
          {
            question: "Can you build a private cinema in Defence Colony Delhi?",
            answer: "Yes, we specialize in building luxury private cinemas in Defence Colony and across Delhi NCR."
          },
          {
