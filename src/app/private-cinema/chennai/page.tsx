...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Private Cinema Chennai - Dolby Atmos 9.4.6 & Custom Acoustics | VARELLI",
  description: "VARELLI designs luxury private cinema systems for villas, penthouses and private residences in Chennai. Architectural integration, European brands & transparent pricing.",
  path: "/private-cinema/chennai",
  keywords: [
    "private cinema Chennai",
    "smart home Chennai",
    "luxury private cinema Chennai",
    "private cinema company Chennai",
    "KNX certified integrator Chennai",
    "villa automation Chennai",
    "home theatre Chennai",
    "Dolby Atmos Chennai",
  ],
});

export default function ChennaiPrivatecinemaPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Chennai",
    url: "https://varelli.co.in/private-cinema/chennai",
    description: "VARELLI designs " + service.name.toLowerCase() + " systems for luxury residences in Chennai."
  });
  ...
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Chennai", href: "/private-cinema/chennai" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            <span className="badge-mono block mb-5">{service.name} · Chennai</span>
        ...
        <section className="py-16 border-b border-[var(--border)] bg-[#08080A]">
          <div className="container-varelli">
            ...
            <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-8">
              Serving Luxury Residences Across Chennai
            </h2>
      ...
      <FAQSection faqs={city.faqs} title="Private Cinema in Chennai — Frequently Asked Questions" />
