...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation Hyderabad - KNX Systems & Smart Living | VARELLI",
  description: "VARELLI designs luxury home automation systems for villas, penthouses and private residences in Hyderabad. Architectural integration, European brands & transparent pricing.",
  path: "/home-automation/hyderabad",
  keywords: [
...
export default function HyderabadHomeautomationPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Hyderabad",
    url: "https://varelli.co.in/home-automation/hyderabad",
  ...
  return (
    <>
      ...
      <FAQSection faqs={city.faqs} title="Home Automation in Hyderabad — Frequently Asked Questions" />
