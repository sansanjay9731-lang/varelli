...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/dlf-phase-5",
title: "Home Automation in DLF Phase 5, Gurgaon — KNX Systems for Gated Luxury Communities",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Dlf Phase 5. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Dlf Phase 5", href: "/home-automation/delhi-ncr/dlf-phase-5" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Dlf Phase 5?",
      answer: "Pricing for luxury automation in Dlf Phase 5 ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Dlf Phase 5?",
    ...
    {
      question: "How do I get a consultation in Dlf Phase 5?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Dlf Phase 5",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/dlf-phase-5",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Automation in DLF Phase 5, Gurgaon — KNX Systems for Gated Luxury Communities</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for DLF Exclusive Floors, The Magnolias, ultra-luxury gated communities</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Dlf Phase 5 Residences</h2>
