...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/noida-sector-44",
title: "Smart Home Automation in Noida — KNX Systems for NCR's Modern Luxury Communities",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Noida Sector 44. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Noida Sector 44", href: "/home-automation/delhi-ncr/noida-sector-44" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Noida Sector 44?",
      answer: "Pricing for luxury automation in Noida Sector 44 ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Noida Sector 44?",
    ...
    {
      question: "How do I get a consultation in Noida Sector 44?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Noida Sector 44",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/noida-sector-44",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Home Automation in Noida — KNX Systems for NCR's Modern Luxury Communities</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Noida Sector 44 properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Noida Sector 44 Residences</h2>
