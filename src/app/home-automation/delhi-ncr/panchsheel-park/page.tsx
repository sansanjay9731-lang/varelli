...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/panchsheel-park",
title: "Luxury Home Automation in Panchsheel Park, Delhi — KNX Systems for Tree-Lined South Delhi",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Panchsheel Park. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Panchsheel Park", href: "/home-automation/delhi-ncr/panchsheel-park" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Panchsheel Park?",
      answer: "Pricing for luxury automation in Panchsheel Park ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Panchsheel Park?",
    ...
    {
      question: "How do I get a consultation in Panchsheel Park?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Panchsheel Park",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/panchsheel-park",
