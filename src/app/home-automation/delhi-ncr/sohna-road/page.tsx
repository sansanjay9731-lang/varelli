...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/sohna-road",
title: "Smart Home Automation on Sohna Road, Gurgaon — KNX Systems for New Gurgaon Residences",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Sohna Road. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Sohna Road", href: "/home-automation/delhi-ncr/sohna-road" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Sohna Road?",
      answer: "Pricing for luxury automation in Sohna Road ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Sohna Road?",
    ...
    {
      question: "How do I get a consultation in Sohna Road?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Sohna Road",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/sohna-road",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Home Automation on Sohna Road, Gurgaon — KNX Systems for New Gurgaon Residences</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Sohna Road properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Sohna Road Residences</h2>
