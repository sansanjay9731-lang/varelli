    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <p className="text-xl md:text-2xl text-[#A0A0A5] mb-8">European Craftsmanship for 10,000+ sq.ft. farmhouses, party venues converted to residences, ultra-luxury</p>
        </div>
      </section>
