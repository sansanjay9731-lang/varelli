...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/jor-bagh",
title: "Luxury Home Automation in Jor Bagh, Delhi — KNX Systems for Delhi's Diplomatic Enclave",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Jor Bagh. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Jor Bagh", href: "/home-automation/delhi-ncr/jor-bagh" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Jor Bagh?",
      answer: "Pricing for luxury automation in Jor Bagh ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Jor Bagh?",
    ...
    {
      question: "How do I get a consultation in Jor Bagh?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Jor Bagh",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/jor-bagh",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Luxury Home Automation in Jor Bagh, Delhi — KNX Systems for Delhi's Diplomatic Enclave</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Jor Bagh properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Jor Bagh Residences</h2>
