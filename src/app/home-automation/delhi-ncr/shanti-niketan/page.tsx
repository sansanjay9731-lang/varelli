...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/shanti-niketan",
title: "Smart Home Automation in Shanti Niketan, Delhi — KNX Systems for South West Delhi Estates",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Shanti Niketan. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Shanti Niketan", href: "/home-automation/delhi-ncr/shanti-niketan" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Shanti Niketan?",
      answer: "Pricing for luxury automation in Shanti Niketan ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Shanti Niketan?",
    ...
    {
      question: "How do I get a consultation in Shanti Niketan?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Shanti Niketan",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/shanti-niketan",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Home Automation in Shanti Niketan, Delhi — KNX Systems for South West Delhi Estates</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Shanti Niketan properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Shanti Niketan Residences</h2>
