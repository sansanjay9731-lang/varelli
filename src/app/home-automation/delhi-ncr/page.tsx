...
const city = getCityBySlug("delhi-ncr")!;

export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation Delhi NCR - KNX Systems & Smart Living | VARELLI",
  description: "VARELLI designs luxury home automation systems for villas, penthouses and private residences in Delhi NCR. Architectural integration, European brands & transparent pricing.",
  path: "/home-automation/delhi-ncr",
  keywords: [
    "home automation Delhi NCR",
    "smart home Delhi NCR",
    "luxury home automation Delhi NCR",
    "home automation company Delhi NCR",
    "KNX certified integrator Delhi NCR",
    "villa automation Delhi NCR",
    "home theatre Delhi NCR",
    "Dolby Atmos Delhi NCR",
  ],
});

export default function DelhincrHomeautomationPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Delhi NCR",
    url: "https://varelli.co.in/home-automation/delhi-ncr",
    description: "VARELLI designs " + service.name.toLowerCase() + " systems for luxury residences in Delhi NCR."
  });
    ...
    <>
      ...
      <section className="relative bg-[var(--surface-1)] border-b border-[var(--border)]">
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              { name: service.name, href: "/home-automation" },
              { name: "Delhi NCR", href: "/home-automation/delhi-ncr" },
            ]}
          />
          <div className="mt-6 max-w-3xl">
            <span className="badge-mono block mb-5">{service.name} · Delhi NCR</span>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                Schedule Delhi NCR Consultation
              </Link>
              <Link
                href="/studio"
        ...
        <section className="py-16 border-b border-[var(--border)] bg-[#08080A]">
          <div className="container-varelli">
            ...
            <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-8">
              Serving Luxury Residences Across Delhi NCR
            </h2>
      ...
      <FAQSection faqs={city.faqs} title="Home Automation in Delhi NCR — Frequently Asked Questions" />
