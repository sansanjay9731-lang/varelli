...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/delhi-ncr/vasant-vihar",
title: "Smart Home Automation in Vasant Vihar, Delhi — KNX Systems for South Delhi Elite Residences",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Vasant Vihar. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Vasant Vihar", href: "/home-automation/delhi-ncr/vasant-vihar" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Vasant Vihar?",
      answer: "Pricing for luxury automation in Vasant Vihar ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Vasant Vihar?",
    ...
    {
      question: "How do I get a consultation in Vasant Vihar?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Vasant Vihar",
    "url": "https://varelli.co.in/home-automation/delhi-ncr/vasant-vihar",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Home Automation in Vasant Vihar, Delhi — KNX Systems for South Delhi Elite Residences</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Vasant Vihar properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Vasant Vihar Residences</h2>
