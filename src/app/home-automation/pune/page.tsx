...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation Pune - KNX Systems & Smart Living | VARELLI",
  description: "VARELLI designs luxury home automation systems for villas, penthouses and private residences in Pune. Architectural integration, European brands & transparent pricing.",
  path: "/home-automation/pune",
  keywords: [
    "home automation Pune",
    "smart home Pune",
    "luxury home automation Pune",
    "home automation company Pune",
...
export default function PuneHomeautomationPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Pune",
    url: "https://varelli.co.in/home-automation/pune",
  ...
  return (
    <>
      ...
      <FAQSection faqs={city.faqs} title="Home Automation in Pune — Frequently Asked Questions" />
