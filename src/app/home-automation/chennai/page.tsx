...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation Chennai - KNX Systems & Smart Living | VARELLI",
  description: "VARELLI designs luxury home automation systems for villas, penthouses and private residences in Chennai. Architectural integration, European brands & transparent pricing.",
  path: "/home-automation/chennai",
  keywords: [
    "home automation Chennai",
    "smart home Chennai",
    "luxury home automation Chennai",
    "home automation company Chennai",
...
export default function ChennaiHomeautomationPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Chennai",
    url: "https://varelli.co.in/home-automation/chennai",
  ...
  return (
    <>
      ...
      <FAQSection faqs={city.faqs} title="Home Automation in Chennai — Frequently Asked Questions" />
