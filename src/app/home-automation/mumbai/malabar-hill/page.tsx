...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/malabar-hill",
title: "Luxury Home Automation in Malabar Hill, Mumbai — KNX Systems for Mumbai's Most Prestigious Address",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Malabar Hill. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Malabar Hill", href: "/home-automation/mumbai/malabar-hill" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Malabar Hill?",
      answer: "Pricing for luxury automation in Malabar Hill ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Malabar Hill?",
    ...
    {
      question: "How do I get a consultation in Malabar Hill?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Malabar Hill",
    "url": "https://varelli.co.in/home-automation/mumbai/malabar-hill",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Luxury Home Automation in Malabar Hill, Mumbai — KNX Systems for Mumbai's Most Prestigious Address</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for oldest money in Mumbai, sea-facing bungalows, hanging gardens proximity, government residences</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Malabar Hill Residences</h2>
