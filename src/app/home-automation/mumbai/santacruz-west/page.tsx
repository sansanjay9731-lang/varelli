...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/santacruz-west",
title: "Home Automation in Santacruz West, Mumbai — KNX Systems for Bungalow Districts",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Santacruz West. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Santacruz West", href: "/home-automation/mumbai/santacruz-west" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Santacruz West?",
      answer: "Pricing for luxury automation in Santacruz West ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Santacruz West?",
    ...
    {
      question: "How do I get a consultation in Santacruz West?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Santacruz West",
    "url": "https://varelli.co.in/home-automation/mumbai/santacruz-west",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Automation in Santacruz West, Mumbai — KNX Systems for Bungalow Districts</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Santacruz West properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Santacruz West Residences</h2>
