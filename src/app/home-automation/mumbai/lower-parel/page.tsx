...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/lower-parel",
title: "Home Automation in Lower Parel, Mumbai — KNX Systems for Mill District Luxury Penthouses",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Lower Parel. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Lower Parel", href: "/home-automation/mumbai/lower-parel" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Lower Parel?",
      answer: "Pricing for luxury automation in Lower Parel ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Lower Parel?",
    ...
    {
      question: "How do I get a consultation in Lower Parel?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Lower Parel",
    "url": "https://varelli.co.in/home-automation/mumbai/lower-parel",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Automation in Lower Parel, Mumbai — KNX Systems for Mill District Luxury Penthouses</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Lower Parel properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Lower Parel Residences</h2>
