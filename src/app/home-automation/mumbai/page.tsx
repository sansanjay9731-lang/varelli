...
export const metadata: Metadata = generatePageMetadata({
  title: "Luxury Home Automation Mumbai - KNX Systems & Smart Living | VARELLI",
  description: "VARELLI designs luxury home automation systems for villas, penthouses and private residences in Mumbai. Architectural integration, European brands & transparent pricing.",
  path: "/home-automation/mumbai",
  keywords: [
    "home automation Mumbai",
    "smart home Mumbai",
    "luxury home automation Mumbai",
...
export default function MumbaiHomeautomationPage() {
  const lbSchema = buildLocalBusinessSchema({
    city: "Mumbai",
    url: "https://varelli.co.in/home-automation/mumbai",
  ...
  return (
    <>
      ...
      <FAQSection faqs={city.faqs} title="Home Automation in Mumbai — Frequently Asked Questions" />
