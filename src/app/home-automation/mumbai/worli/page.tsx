...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/worli",
title: "Home Automation in Worli, Mumbai — Smart Living for the City's Skyline Residences",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Worli. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Worli", href: "/home-automation/mumbai/worli" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Worli?",
      answer: "Pricing for luxury automation in Worli ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Worli?",
    ...
    {
      question: "How do I get a consultation in Worli?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Worli",
    "url": "https://varelli.co.in/home-automation/mumbai/worli",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Home Automation in Worli, Mumbai — Smart Living for the City's Skyline Residences</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Lodha Altamount, Peninsula, sea-link views, ultra-luxury high-rises</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Worli Residences</h2>
