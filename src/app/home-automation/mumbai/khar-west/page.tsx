...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/khar-west",
title: "Smart Home Automation in Khar West, Mumbai — Luxury Smart Living for Suburban Residences",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Khar West. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Khar West", href: "/home-automation/mumbai/khar-west" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Khar West?",
      answer: "Pricing for luxury automation in Khar West ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Khar West?",
    ...
    {
      question: "How do I get a consultation in Khar West?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Khar West",
    "url": "https://varelli.co.in/home-automation/mumbai/khar-west",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Smart Home Automation in Khar West, Mumbai — Luxury Smart Living for Suburban Residences</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Khar West properties</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Khar West Residences</h2>
