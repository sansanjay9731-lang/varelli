...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/bandra-west",
title: "Luxury Home Automation in Bandra West, Mumbai — KNX Systems for Sea-Facing Penthouses",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Bandra West. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Bandra West", href: "/home-automation/mumbai/bandra-west" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Bandra West?",
      answer: "Pricing for luxury automation in Bandra West ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Bandra West?",
    ...
    {
      question: "How do I get a consultation in Bandra West?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Bandra West",
    "url": "https://varelli.co.in/home-automation/mumbai/bandra-west",
    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="hero w-full py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Luxury Home Automation in Bandra West, Mumbai — KNX Systems for Sea-Facing Penthouses</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">European Craftsmanship for Bollywood celebrities, sea-facing penthouses, heritage bungalows, bandra hill road</p>
        </div>
      </section>
      
      <section className="services w-full py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-3xl font-bold mb-8">Services for Bandra West Residences</h2>
