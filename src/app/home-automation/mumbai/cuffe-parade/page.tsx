...
export const metadata: Metadata = generatePageMetadata({
  path: "/home-automation/mumbai/cuffe-parade",
title: "Smart Home Automation in Cuffe Parade, Mumbai — Architecture-Led KNX for South Mumbai Residences",
  description: "Experience ultra-luxury European craftsmanship with KNX certified home automation systems in Cuffe Parade. Brands include Basalte, Ekinex, Sonus Faber and more.",
})
...
export default function Page() {
  const breadcrumbItems = [
    ...
    { name: "Cuffe Parade", href: "/home-automation/mumbai/cuffe-parade" }
  ]

  const faqs = [
    {
      question: "What is the typical cost of home automation in Cuffe Parade?",
      answer: "Pricing for luxury automation in Cuffe Parade ranges from ₹4.8L–₹7.5L for Core systems, ₹14.5L–₹24L for Architectural, and ₹38L–₹65L+ for Grand Estates."
    },
    {
      question: "Do you provide KNX systems in Cuffe Parade?",
    ...
    {
      question: "How do I get a consultation in Cuffe Parade?",
  ...
  const schemaData = {
    ...
    "name": "VARELLI Home Automation - Cuffe Parade",
    "url": "https://varelli.co.in/home-automation/mumbai/cuffe-parade",
