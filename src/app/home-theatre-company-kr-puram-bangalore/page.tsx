...
export function generateMetadata(): Metadata {
  return generatePageMetadata({
    title: 'Home Theatre Company in Kr Puram, Bangalore — Dolby Atmos | VARELLI',
    description: 'Top-rated home theatre company in Kr Puram, Bangalore. Experience Dolby Atmos surround sound with premium brands.',
    path: '/home-theatre-company-kr-puram-bangalore'
  })
}
...
export default function HomeTheatreCompanyPage() {
  const schema = {
    ...
    "name": "VARELLI - Home Theatre Company Kr Puram",
    "description": "Premium home theatre design and installation in Kr Puram, Bangalore.",
    "mainEntity": [
      {
        "@type": "Question",
        "name": "best home theatre company kr-puram bangalore",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "VARELLI offers bespoke home theatre design and installation in Kr Puram, featuring top brands like Sonus Faber and KEF."
        }
      },
      {
        "@type": "Question",
        "name": "home theatre installation cost kr-puram",
        "acceptedAnswer": {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        "name": "dolby atmos kr-puram bangalore",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "VARELLI designs and installs custom Dolby Atmos home theatres in Kr Puram."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <main className="bg-black text-white min-h-screen">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">Home Theatre Company in Kr Puram, Bangalore</h1>
          
          <h2 className="text-2xl md:text-3xl font-semibold mb-6">Why VARELLI Is Kr Puram&apos;s Best Home Theatre Company</h2>
          ...
          <div className="mb-12">
            ...
            <ul className="flex flex-col gap-2">
              ...
              <li><Link href={`/private-cinema/bangalore/kr-puram`} className="text-blue-400 hover:underline">Private Cinema in Kr Puram</Link></li>
            </ul>
          </div>
