...
export const metadata: Metadata = generatePageMetadata({
  title: "Home Security System in Hebbal, Bangalore — CCTV & Smart Access | VARELLI",
  description: "Integrated smart home security — Hikvision 4K CCTV, DoorBird video doorbell, KNX access control for luxury residences in Hebbal, Bangalore.",
  path: "/home-security/bangalore/hebbal",
  keywords: ["home security Hebbal bangalore", "CCTV installation Hebbal", "smart security bangalore", "home security company bangalore"],
})

const localBusinessSchema = {
  "@context": "https://schema.org",
  "@type": "LocalBusiness",
  "name": "VARELLI - Home Security Hebbal",
  "address": {
    "@type": "PostalAddress",
...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Who is the best home security company in Hebbal, Bangalore?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "VARELLI provides the best home security systems in Hebbal, integrating premium brands like Hikvision and DoorBird for robust and seamless security."
      }
    },
    {
      "@type": "Question",
      "name": "Do you provide CCTV camera installation in Hebbal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, we specialize in high-end CCTV camera installation in Hebbal, featuring 4K IP cameras with AI analytics and KNX integration."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How much does a smart home security system cost in Hebbal?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Our security systems in Hebbal range from ₹1.2 Lakhs for essential setups to over ₹18 Lakhs for comprehensive, multi-layered security."
      }
    },
    {
      "@type": "Question",
...
export default function HomeSecurityHebbalPage() {
  return (
    <>
        ...
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb
            items={[
              ...
              { name: "Hebbal", href: "/home-security/bangalore/hebbal" }
            ]}
          />
          <div className="mt-6 max-w-3xl">
            <h1 className="font-display text-[clamp(2.2rem,5vw,4rem)] font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Smart Home Security in Hebbal, Bangalore — Hikvision CCTV & DoorBird Access
            </h1>
            <p className="text-[var(--text-secondary)] text-lg leading-relaxed font-body">
              Premium home security installations for luxury villas and apartments in Hebbal. We integrate Hikvision 4K cameras, DoorBird intercoms, and KNX access control for uncompromised safety.
            </p>
          </div>
        </div>
      </section>
      ...
      <FAQSection faqs={[
        {
          question: "Who is the best home security company in Hebbal, Bangalore?",
          answer: "VARELLI provides the best home security systems in Hebbal, integrating premium brands like Hikvision and DoorBird for robust and seamless security."
        },
        {
          question: "Do you provide CCTV camera installation in Hebbal?",
          answer: "Yes, we specialize in high-end CCTV camera installation in Hebbal, featuring 4K IP cameras with AI analytics and KNX integration."
        },
        {
        ...
        {
          question: "How much does a smart home security system cost in Hebbal?",
          answer: "Our security systems in Hebbal range from ₹1.2 Lakhs for essential setups to over ₹18 Lakhs for comprehensive, multi-layered security."
        },
        {
