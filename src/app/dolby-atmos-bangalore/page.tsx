...
export const metadata: Metadata = generatePageMetadata({
  title: "Dolby Atmos Home Theatre in Bangalore — Professional Installation | VARELLI",
  description: "VARELLI is the leading luxury integrator for Dolby Atmos Home Theatre in Bangalore — Professional Installation. Discover premium smart home and private cinema solutions.",
  path: "/dolby-atmos-bangalore",
  keywords: ["dolby-atmos-bangalore", "bangalore"],
})
...
const localBusinessSchema = {
  ...
  "@type": "LocalBusiness",
  name: "VARELLI",
  url: "https://varelli.co.in/dolby-atmos-bangalore",
      ...
      <section className="relative bg-[var(--surface-1)] border-b border-[var(--border)]">
        <div className="relative container-varelli pt-40 pb-16">
          <Breadcrumb items={[
            ...
            { name: "Dolby Atmos Home Theatre in Bangalore — Professional Installation", href: "/dolby-atmos-bangalore" },
          ]} />
          <div className="mt-6 max-w-3xl">
            <h1 className="font-display text-[clamp(2.2rem,5vw,4rem)] font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text-primary)] mb-5">
              Dolby Atmos Home Theatre in Bangalore — Professional Installation
            </h1>
