...
import { Menu, X, ArrowUpRight, Sparkles } from "@/components/ui/icons";
...
const navigationLinks = [
  {
    ...
    children: [
      { name: "Home Automation", href: "/home-automation", desc: "KNX infrastructure, scene control, single-app orchestration." },
      { name: "Private Cinema", href: "/private-cinema", desc: "Dolby Atmos reference cinemas, 4K laser projection." },
      { name: "Fresh Air Ventilation", href: "/fresh-air-ventilation", desc: "Continuous filtered outdoor air, IAQ monitoring." },
      { name: "Central Vacuum", href: "/central-vacuum", desc: "Built-in whole-home vacuum infrastructure." },
      { name: "Smart Security & Networking", href: "/home-security", desc: "Biometric access, AI surveillance, enterprise WiFi." },
    ],
  },
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[rgba(8,8,10,0.85)] backdrop-blur-md border-b border-[var(--border)]">
      <div className="container-varelli h-20 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-sm font-body">
          <Link
            href="/studio"
